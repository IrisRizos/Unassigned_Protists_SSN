...
```{r}
Rhythmicity_ASTAN_final <- read_csv("Rhythmicity_ASTAN_final.csv")
Rhythmicity_ASTAN_final<-Rhythmicity_ASTAN_final[,-1]
```

Import the treated data
```{r}
CC_Synd_ASTAN_All <- read_csv("CC_Synd_ASTAN_All.csv")
...
Filter the Rhythmicity table to only keep the rythmic CC 

```{r}
Rhythmicity_ASTAN_final<-Rhythmicity_ASTAN_final%>% filter(Periodicity==1)
```
...
Import the rythmic and escouffier-selected CC
```{r}
Rhythmicity_BBMO_final <- read_csv("Rhythmicity_BBMO_final.csv")
Rhythmicity_BBMO_final<-Rhythmicity_BBMO_final[,-1]
```

Import the treated data
```{r}
CC_Synd_BBMO_All <- read_csv("CC_Synd_BBMO_All.csv")
...
```{r}
Rhythmicity_BBMO_final<-Rhythmicity_BBMO_final%>% filter(Periodicity==1)
```
...
Import the rythmic and escouffier-selected CC
```{r}
Rhythmicity_SOLA_final <- read_csv("Rhythmicity_SOLA_final.csv")
Rhythmicity_SOLA_final<-Rhythmicity_SOLA_final[,-1]
```

Import the treated data
```{r}
CC_Synd_SOLA_All <- read_csv("CC_Synd_SOLA_All.csv")
...
```{r}
Rhythmicity_SOLA_final<-Rhythmicity_SOLA_final%>% filter(Periodicity==1)
```
