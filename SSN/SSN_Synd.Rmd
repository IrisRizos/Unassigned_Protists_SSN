...
write.csv(comp_sizes,'CC_sizes_100_cov80.csv')
sum(comp_sizes)
summary(comp_sizes)
hist(comp_sizes[,1])
```
...
# 2.2 And how many contain unassigned sequences ?
...
(length(dg_synd_uk)/length(dg_synd_uk))*100
