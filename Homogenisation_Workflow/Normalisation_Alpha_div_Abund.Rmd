...
tax_all=read.csv("/shared/projects/formaldark/Data_stageM2/All_seq_taxTable_noAB_PR2.csv",h=T,sep=";")

# Biomarks
biom <- subset(tax_all, tax_all$ASV %like% "ASV_Biom_")

UK_biom_K <- 100*(nrow(biom[biom$Kingdom=="Unknown",]))/nrow(biom)
UK_biom_S <- 100*(nrow(biom[biom$Supegroup=="Unknown",]))/nrow(biom)
...
UK_astan_S <- 100*(nrow(astan[astan$Supegroup=="Unknown",]))/nrow(astan)
...
UK_bbmo_S <- 100*(nrow(bbmo[bbmo$Supegroup=="Unknown",]))/nrow(bbmo)
...
UK_sola_S <- 100*(nrow(sola[sola$Supegroup=="Unknown",]))/nrow(sola)
...
UK_mal_S <- 100*(nrow(mal[mal$Supegroup=="Unknown",]))/nrow(mal)
...
UK_moo_S <- 100*(nrow(moo[moo$Supegroup=="Unknown",]))/nrow(moo)
...
## Varna
# Read ASV table
abund2=read.csv("/shared/projects/formaldark/datasets/Biomarks/omics/Biom_Varna_abund_N2_PR2_filt.csv",h=T, sep=",")

# Set row names (ASV) as first column
abund2 <- cbind(rownames(abund2), data.frame(abund2, row.names=NULL))
abund2 <- abund2[,2:ncol(abund2)]
colnames(abund2)[1] <- "ASV"

# Read abundance table
t=read.csv("/shared/projects/formaldark/datasets/Biomarks/omics/ASV_Biom_Varna_filt_PR2_f200.csv",h=T, sep=";")

# Merge abundance with taxonomy
ASV_tax_N <- merge(abund2, t, by = "ASV")
...
s <- colSums(Kingdom[,2:22])

# Get mean unknown abundance 
Kingdom_V <- mean(s)*100

#- Supergroup level -#
Supergroup <- subset(ASV_tax_N, Supergroup == "Unknown")
s <- colSums(Supergroup[,2:22])
Supergroup_V <- mean(s)*100

#- Division level -#
Division <- subset(ASV_tax_N, Division == "Unknown")
s <- colSums(Division[,2:22])
Division_V <- mean(s)*100

#- Class level -#
Class <- subset(ASV_tax_N, Class == "Unknown")
s <- colSums(Class[,2:22])
Class_V <- mean(s)*100

#- Order level -#
Order <- subset(ASV_tax_N, Order == "Unknown")
s <- colSums(Order[,2:22])
Order_V <- mean(s)*100

#- Family level -#
Family <- subset(ASV_tax_N, Family == "Unknown")
s <- colSums(Family[,2:22])
Family_V <- mean(s)*100

#- Genus level -#
Genus <- subset(ASV_tax_N, Genus == "Unknown")
s <- colSums(Genus[,2:22])
Genus_V <- mean(s)*100

#- Species level -#
Species <- subset(ASV_tax_N, Species == "Unknown")
s <- colSums(Species[,2:22])
Species_V <- mean(s)*100

## Barcelona
# Read ASV table
abund2=read.csv("/shared/projects/formaldark/datasets/Biomarks/omics/Biom_Barc_abund_N2_PR2_filt.csv",h=T, sep=",")
...
# Read abundance table
t=read.csv("/shared/projects/formaldark/datasets/Biomarks/omics/ASV_Biom_Barc_filt_PR2_f200.csv",h=T, sep=";")
...
# Get abundance of unknown metabarcodes  
# Get sum of unknown abundance per sample
s <- colSums(Kingdom[,2:10])

# Get mean unknown abundance 
Kingdom_B <- mean(s)*100

#- Supergroup level -#
Supergroup <- subset(ASV_tax_N, Supergroup == "Unknown")
s <- colSums(Supergroup[,2:10])
Supergroup_B <- mean(s)*100

#- Division level -#
Division <- subset(ASV_tax_N, Division == "Unknown")
s <- colSums(Division[,2:10])
Division_B <- mean(s)*100

#- Class level -#
Class <- subset(ASV_tax_N, Class == "Unknown")
s <- colSums(Class[,2:10])
Class_B <- mean(s)*100

#- Order level -#
Order <- subset(ASV_tax_N, Order == "Unknown")
s <- colSums(Order[,2:10])
Order_B <- mean(s)*100

#- Family level -#
Family <- subset(ASV_tax_N, Family == "Unknown")
s <- colSums(Family[,2:10])
Family_B <- mean(s)*100

#- Genus level -#
Genus <- subset(ASV_tax_N, Genus == "Unknown")
s <- colSums(Genus[,2:10])
Genus_B <- mean(s)*100

#- Species level -#
Species <- subset(ASV_tax_N, Species == "Unknown")
s <- colSums(Species[,2:10])
Species_B <- mean(s)*100

## Gijon
# Read ASV table
abund2=read.csv("/shared/projects/formaldark/datasets/Biomarks/omics/Biom_Gijon_abund_N2_PR2_filt.csv",h=T, sep=",")
...
# Read abundance table
t=read.csv("ASV_Biom_Gijon_filt_PR2_f200.csv",h=T, sep=";")
...
# Get abundance of unknown metabarcodes  
# Get sum of unknown abundance per sample
s <- colSums(Kingdom[,2:5])

# Get mean unknown abundance 
Kingdom_G <- mean(s)*100

#- Supergroup level -#
Supergroup <- subset(ASV_tax_N, Supergroup == "Unknown")
s <- colSums(Supergroup[,2:5])
Supergroup_G <- mean(s)*100

#- Division level -#
Division <- subset(ASV_tax_N, Division == "Unknown")
s <- colSums(Division[,2:5])
Division_G <- mean(s)*100
...
#- Species level -#
Species <- subset(ASV_tax_N, Species == "Unknown")
s <- colSums(Species[,2:5])
Species_G <- mean(s)*100

## Naples
# Read ASV table
abund2=read.csv("/shared/projects/formaldark/datasets/Biomarks/omics/Biom_Naples_abund_N2_PR2_filt.csv",h=T, sep=",")
...
# Read abundance table
t=read.csv("/shared/projects/formaldark/datasets/Biomarks/omics/ASV_Biom_Naples_filt_PR2_f200.csv",h=T, sep=";")
...
# Get abundance of unknown metabarcodes  
# Get sum of unknown abundance per sample
s <- colSums(Kingdom[,2:41])

# Get mean unknown abundance 
Kingdom_N <- mean(s)*100

#- Supergroup level -#
Supergroup <- subset(ASV_tax_N, Supergroup == "Unknown")
s <- colSums(Supergroup[,2:41])
Supergroup_N <- mean(s)*100

#- Division level -#
Division <- subset(ASV_tax_N, Division == "Unknown")
s <- colSums(Division[,2:41])
Division_N <- mean(s)*100

#- Class level -#
Class <- subset(ASV_tax_N, Class == "Unknown")
s <- colSums(Class[,2:41])
Class_N <- mean(s)*100

#- Order level -#
Order <- subset(ASV_tax_N, Order == "Unknown")
s <- colSums(Order[,2:41])
Order_N <- mean(s)*100

#- Family level -#
Family <- subset(ASV_tax_N, Family == "Unknown")
s <- colSums(Family[,2:41])
Family_N <- mean(s)*100

#- Genus level -#
Genus <- subset(ASV_tax_N, Genus == "Unknown")
s <- colSums(Genus[,2:41])
Genus_N <- mean(s)*100

#- Species level -#
Species <- subset(ASV_tax_N, Species == "Unknown")
s <- colSums(Species[,2:41])
Species_N <- mean(s)*100

## Roscoff
# Read ASV table
abund2=read.csv("/shared/projects/formaldark/datasets/Biomarks/omics/Biom_Rosc_abund_N2_PR2_filt.csv",h=T, sep=",")
...
# Read abundance table
t=read.csv("/shared/projects/formaldark/datasets/Biomarks/omics/ASV_Biom_Rosc_filt_PR2_f200.csv",h=T, sep=";")
...
# Get abundance of unknown metabarcodes  
# Get sum of unknown abundance per sample
s <- colSums(Kingdom[,2:8])

# Get mean unknown abundance 
Kingdom_R <- mean(s)*100

#- Supergroup level -#
Supergroup <- subset(ASV_tax_N, Supergroup == "Unknown")
s <- colSums(Supergroup[,2:8])
Supergroup_R <- mean(s)*100

#- Division level -#
Division <- subset(ASV_tax_N, Division == "Unknown")
s <- colSums(Division[,2:8])
Division_R <- mean(s)*100
...
#- Species level -#
Species <- subset(ASV_tax_N, Species == "Unknown")
s <- colSums(Species[,2:8])
Species_R <- mean(s)*100

## Oslo
# Read ASV table
abund2=read.csv("/shared/projects/formaldark/datasets/Biomarks/omics/Biom_Oslo_abund_N2_PR2_filt.csv",h=T, sep=",")
...
# Read abundance table
t=read.csv("/shared/projects/formaldark/datasets/Biomarks/omics/ASV_Biom_Oslo_filt_PR2_f200.csv",h=T, sep=";")
...
# Get abundance of unknown metabarcodes  
# Get sum of unknown abundance per sample
s <- colSums(Kingdom[,2:35])

# Get mean unknown abundance 
Kingdom_O <- mean(s)*100

#- Supergroup level -#
Supergroup <- subset(ASV_tax_N, Supergroup == "Unknown")
s <- colSums(Supergroup[,2:35])
Supergroup_O <- mean(s)*100

#- Division level -#
Division <- subset(ASV_tax_N, Division == "Unknown")
s <- colSums(Division[,2:8])
Division_O <- mean(s)*100
...
Species <- subset(ASV_tax_N, Species == "Unknown")
s <- colSums(Species[,2:8])
Species_O <- mean(s)*100

# Biomarks sum of unknown metabarcode abundance 
Kingdom <- mean(Kingdom_V, Kingdom_B, Kingdom_G, Kingdom_N, Kingdom_R, Kingdom_O)
Supergroup <- mean(Supergroup_V, Supergroup_B, Supergroup_G, Supergroup_N, Supergroup_R, Supergroup_O)
Division <- mean(Division_V, Division_B, Division_G, Division_N, Division_R, Division_O)
Class <- mean(Class_V, Class_B, Class_G, Class_N, Class_R, Class_O)
Order <- mean(Order_V, Order_B, Order_G, Order_N, Order_R, Order_O)
Family <- mean(Family_V, Family_B, Family_G, Family_N, Family_R, Family_O)
Genus <- mean(Genus_V, Genus_B, Genus_G, Genus_N, Genus_R, Genus_O)
Species <- mean(Species_V, Species_B, Species_G, Species_N, Species_R, Species_O)

##-- BBMO --##
# Read ASV table
abund2=read.csv("BBMO_abund_N2_PR2_filt.csv",h=T, sep=",")
...
# Read abundance table
t=read.csv("ASV_BBMO_filt_PR2_f200.csv",h=T, sep=";")
...
#- Supergroup level -#
Supergroup <- subset(ASV_tax_N, Supergroup == "Unknown")
s <- colSums(Supergroup[,2:328])
mean(s)*100

#- Division level -#
Division <- subset(ASV_tax_N, Division == "Unknown")
s <- colSums(Division[,2:328])
mean(s)*100

#- Class level -#
Class <- subset(ASV_tax_N, Class == "Unknown")
s <- colSums(Class[,2:328])
mean(s)*100

#- Order level -#
Order <- subset(ASV_tax_N, Order == "Unknown")
s <- colSums(Order[,2:328])
mean(s)*100

#- Family level -#
Family <- subset(ASV_tax_N, Family == "Unknown")
s <- colSums(Family[,2:328])
mean(s)*100

#- Genus level -#
Genus <- subset(ASV_tax_N, Genus == "Unknown")
s <- colSums(Genus[,2:328])
mean(s)*100

#- Species level -#
Species <- subset(ASV_tax_N, Species == "Unknown")
s <- colSums(Species[,2:328])
mean(s)*100

##-- MALASPINA --##
# Read ASV table
abund2=read.csv("Mal_abund_N2_PR2_filt.csv",h=T, sep=",")
...
# Read abundance table
t=read.csv("ASV_Malaspina_filt_PR2_f200.csv",h=T, sep=";")
...
#- Supergroup level -#
Supergroup <- subset(ASV_tax_N, Supergroup == "Unknown")
s <- colSums(Supergroup[,2:290])
mean(s)*100

#- Division level -#
Division <- subset(ASV_tax_N, Division == "Unknown")
s <- colSums(Division[,2:290])
mean(s)*100

#- Class level -#
Class <- subset(ASV_tax_N, Class == "Unknown")
s <- colSums(Class[,2:290])
mean(s)*100

#- Order level -#
Order <- subset(ASV_tax_N, Order == "Unknown")
s <- colSums(Order[,2:290])
mean(s)*100

#- Family level -#
Family <- subset(ASV_tax_N, Family == "Unknown")
s <- colSums(Family[,2:290])
mean(s)*100

#- Genus level -#
Genus <- subset(ASV_tax_N, Genus == "Unknown")
s <- colSums(Genus[,2:290])
mean(s)*100

#- Species level -#
Species <- subset(ASV_tax_N, Species == "Unknown")
s <- colSums(Species[,2:290])
mean(s)*100

##-- MOOSE --##
# Read ASV table
abund2=read.csv("MOOSE_abund_N2_PR2_filt.csv",h=T, sep=",")
...
# Read abundance table
t=read.csv("ASV_MOOSE_filt_PR2_f200.csv",h=T, sep=";")

# Merge abundance with taxonomy
ASV_tax_N <- merge(abund2, t, by = "ASV")

# Remove Samples with 0 abund (mean = NA)
ASV_tax_N$MGE18.65.L2.net.500.DNA2.x <- NULL
...
#- Supergroup level -#
Supergroup <- subset(ASV_tax_N, Supergroup == "Unknown")
s <- colSums(Supergroup[,2:273])
mean(s)*100

#- Division level -#
Division <- subset(ASV_tax_N, Division == "Unknown")
s <- colSums(Division[,2:273])
mean(s)*100

#- Class level -#
Class <- subset(ASV_tax_N, Class == "Unknown")
s <- colSums(Class[,2:273])
mean(s)*100

#- Order level -#
Order <- subset(ASV_tax_N, Order == "Unknown")
s <- colSums(Order[,2:273])
mean(s)*100

#- Family level -#
Family <- subset(ASV_tax_N, Family == "Unknown")
s <- colSums(Family[,2:273])
mean(s)*100

#- Genus level -#
Genus <- subset(ASV_tax_N, Genus == "Unknown")
s <- colSums(Genus[,2:273])
mean(s)*100

#- Species level -#
Species <- subset(ASV_tax_N, Species == "Unknown")
s <- colSums(Species[,2:273])
mean(s)*100

##-- SOLA --##
# Read ASV table
abund2=read.csv("SOLA_abund_N2_PR2_filt.csv",h=T, sep=",")
...
# Read abundance table
t=read.csv("ASV_SOLA_filt_PR2_f200.csv",h=T, sep=";")

# Merge abundance with taxonomy
ASV_tax_N <- merge(abund2, t, by = "ASV")

# Remove Samples with 0 abund (mean = NA)
ASV_tax_N$X3816.31.Euk515.Euk951.x <- NULL
ASV_tax_N$X3816.118.Euk515.Euk951.x <- NULL
ASV_tax_N$X3816.101.Euk515.Euk951.x <- NULL
ASV_tax_N$X3816.149.Euk515.Euk951.x <- NULL
...
##-- ASTAN --##
# Read ASV table
abund2=read.csv("ASTAN_abund_N2_PR2_filt.csv",h=T, sep=",")
...
# Read abundance table
t=read.csv("ASV_ASTAN_filt_PR2_f200.csv",h=T, sep=";")
...
#- Supergroup level -#
Supergroup <- subset(ASV_tax_N, Supergroup == "Unknown")
s <- colSums(Supergroup[,2:375])
mean(s)*100

#- Division level -#
Division <- subset(ASV_tax_N, Division == "Unknown")
s <- colSums(Division[,2:375])
mean(s)*100

#- Class level -#
Class <- subset(ASV_tax_N, Class == "Unknown")
s <- colSums(Class[,2:375])
mean(s)*100

#- Order level -#
Order <- subset(ASV_tax_N, Order == "Unknown")
s <- colSums(Order[,2:375])
mean(s)*100

#- Family level -#
Family <- subset(ASV_tax_N, Family == "Unknown")
s <- colSums(Family[,2:375])
mean(s)*100

#- Genus level -#
Genus <- subset(ASV_tax_N, Genus == "Unknown")
s <- colSums(Genus[,2:375])
mean(s)*100

#- Species level -#
Species <- subset(ASV_tax_N, Species == "Unknown")
s <- colSums(Species[,2:375])
mean(s)*100
###################
```

Numbers are pasted in the csv file used for the plot.

```{r}
## Plot
donUK_PR2_F_abund=read.csv("/shared/projects/formaldark/Data_stageM2/UK_Perc_PR2_allFilt_abundance.csv",h=T,sep=";")

donUK_PR2_F_abund$Taxo_level <- factor(donUK_PR2_F_abund$Taxo_level,levels = c("Kingdom", "Supergroup", "Division", "Class", "Order","Family","Genus","Species"))
donUK_PR2_F_abund$Dataset <- factor(donUK_PR2_F_abund$Dataset,levels = c("BioMarKs", "ASTAN", "BBMO", "SOLA","Malaspina","MOOSE"))

p2 <- ggplot(donUK_PR2_F_abund, aes(fill=Dataset, y=Unknowns, x=Taxo_level)) + 
  geom_bar(position="dodge", stat="identity", colour="black") +
  geom_hline(aes(yintercept=50.00), color="red", linetype="dashed", size=0.5) +
  theme_linedraw() +
  facet_grid(~Taxo_level, scales = "free_x") +
...
```{r}
# Read taxonomy table 
d=read.csv("/shared/projects/formaldark/Data_stageM2/All_seq_taxTable_noAB_PR2.csv", h=T, sep=";",stringsAsFactors = TRUE)
...
df <- data.frame(sort((summary(A$Division)/sum(summary(A$Division)))*100))

# Quantification of Syndiales and Dinophyceae among Dinoflagellata
D <- (A[A$Division=="Dinoflagellata",])
df_class <- data.frame((summary(D$Class)/nrow(D)*100))
...
```{r}
# Read data
don=read.csv("/shared/projects/formaldark/Data_stageM2/Division_abund_div.csv",h=T, sep=";",stringsAsFactors = TRUE)
...
#-#
# Quantification of Syndiales and Dinophyceae among Dinoflagellata
S <- Genus_dino[Genus_dino$Class=="Syndiniales",]
DD <- Genus_dino[Genus_dino$Class=="Dinophyceae",]

df_class_S_varna <- data.frame((colSums(S[,2:22])/colSums(Genus_dino[,2:22]))*100)
M_S_varna <- mean(df_class_S_varna[,1])
df_class_DD_varna <- data.frame((colSums(DD[,2:22])/colSums(Genus_dino[,2:22]))*100)
M_DD_varna <- mean(df_class_DD_varna[,1])
...
K_S_varna <- S[S$Genus!="Unknown",]
K_S_varna <- mean(data.frame((colSums(K_S_varna[,2:22])/colSums(S[,2:22]))*100)[,1])
UK_S_varna <- S[S$Genus=="Unknown",]
UK_S_varna <- mean(data.frame((colSums(UK_S_varna[,2:22])/colSums(S[,2:22]))*100)[,1])

K_DD_varna <- DD[DD$Genus!="Unknown",]
K_DD_varna <- mean(data.frame(((colSums(K_DD_varna[,2:22])/colSums(DD[,2:22]))*100))[,1])
UK_DD_varna <- DD[DD$Genus=="Unknown",]
UK_DD_varna <- mean(data.frame(((colSums(UK_DD_varna[,2:22])/colSums(DD[,2:22]))*100))[,1])
#-#

# Alpha diversity of known, unknown and all Dinoflagellata
Genus_dino_alpha_unknown <- data.frame(Genus_dino[,1:22])
rownames(Genus_dino_alpha_unknown)<-Genus_dino_alpha_unknown[,1]
Genus_dino_alpha_unknown[,1]<-NULL

Genus_known <- subset(ASV_tax_N, Genus != "Unknown")
Genus_dino_known <- Genus_known[Genus_known$Division=="Dinoflagellata",]
Genus_dino_alpha_known <- data.frame(Genus_dino_known[,1:22])
rownames(Genus_dino_alpha_known)<-Genus_dino_alpha_known[,1]
Genus_dino_alpha_known[,1]<-NULL

Genus_dino_all <- subset(ASV_tax_N, Division=="Dinoflagellata")
Genus_dino_alpha_all <- data.frame(Genus_dino_all[,1:22])
rownames(Genus_dino_alpha_all)<-Genus_dino_alpha_all[,1]
Genus_dino_alpha_all[,1]<-NULL

# Shannon diversity index 
dino_div_varna_unknown <- data.frame(diversity(Genus_dino_alpha_unknown, index = "shannon",MARGIN=2))
Group <- rep("Dinoflagellata",21)
shannon_biomarks_unknown <- cbind(dino_div_varna_unknown,Group)
names(shannon_biomarks_unknown)[1]<-paste("Shannon")

dino_div_varna_known <- data.frame(diversity(Genus_dino_alpha_known, index = "shannon",MARGIN=2))
Group <- rep("Dinoflagellata",21)
shannon_biomarks_known <- cbind(dino_div_varna_known,Group)
names(shannon_biomarks_known)[1]<-paste("Shannon")

dino_div_varna_all <- data.frame(diversity(Genus_dino_alpha_all, index = "shannon",MARGIN=2))
Group <- rep("Dinoflagellata",21)
shannon_biomarks_all <- cbind(dino_div_varna_all,Group)
names(shannon_biomarks_all)[1]<-paste("Shannon")

# Keep Ochro Division
Genus_ochro_unknown<- Genus[Genus$Division=="Ochrophyta",]
Genus_ochro_alpha_unknown <- data.frame(Genus_ochro_unknown[,1:22])
rownames(Genus_ochro_alpha_unknown)<-Genus_ochro_alpha_unknown[,1]
Genus_ochro_alpha_unknown[,1]<-NULL

Genus_known <- subset(ASV_tax_N, Genus != "Unknown")
Genus_ochro_known <- Genus_known[Genus_known$Division=="Ochrophyta",]
Genus_ochro_alpha_known <- data.frame(Genus_ochro_known[,1:22])
rownames(Genus_ochro_alpha_known)<-Genus_ochro_alpha_known[,1]
Genus_ochro_alpha_known[,1]<-NULL

Genus_ochro_all <- subset(ASV_tax_N, Division=="Ochrophyta")
Genus_ochro_alpha_all <- data.frame(Genus_ochro_all[,1:22])
rownames(Genus_ochro_alpha_all)<-Genus_ochro_alpha_all[,1]
Genus_ochro_alpha_all[,1]<-NULL

# Shannon diversity index 
ochro_div_varna_unknown <- data.frame(diversity(Genus_ochro_alpha_unknown, index = "shannon",MARGIN=2))
Group <- rep("Ochrophyta",21)
ochro_biomarks_unknown <- cbind(ochro_div_varna_unknown,Group)
...
ochro_div_varna_known <- data.frame(diversity(Genus_ochro_alpha_known, index = "shannon",MARGIN=2))
Group <- rep("Ochrophyta",21)
ochro_biomarks_known <- cbind(ochro_div_varna_known,Group)
names(ochro_biomarks_known)[1]<-paste("Shannon")
shannon_biomarks_known <- rbind(shannon_biomarks_known,ochro_biomarks_known)

ochro_div_varna_all <- data.frame(diversity(Genus_ochro_alpha_all, index = "shannon",MARGIN=2))
Group <- rep("Ochrophyta",21)
ochro_biomarks_all <- cbind(ochro_div_varna_all,Group)
...
Genus_cilio_alpha_unknown <- data.frame(Genus_cilio_unknown[,1:22])
rownames(Genus_cilio_alpha_unknown)<-Genus_cilio_alpha_unknown[,1]
Genus_cilio_alpha_unknown[,1]<-NULL

Genus_known <- subset(ASV_tax_N, Genus != "Unknown")
Genus_cilio_known <- Genus_known[Genus_known$Division=="Ciliophora",]
Genus_cilio_alpha_known <- data.frame(Genus_cilio_known[,1:22])
rownames(Genus_cilio_alpha_known)<-Genus_cilio_alpha_known[,1]
Genus_cilio_alpha_known[,1]<-NULL

Genus_cilio_all <- subset(ASV_tax_N, Division=="Ciliophora")
Genus_cilio_alpha_all <- data.frame(Genus_cilio_all[,1:22])
rownames(Genus_cilio_alpha_all)<-Genus_cilio_alpha_all[,1]
Genus_cilio_alpha_all[,1]<-NULL

# Shannon diversity index 
cilio_div_varna_unknown <- data.frame(diversity(Genus_cilio_alpha_unknown, index = "shannon",MARGIN=2))
Group <- rep("Ciliophora",21)
cilio_biomarks_unknown <- cbind(cilio_div_varna_unknown,Group)
...
cilio_div_varna_known <- data.frame(diversity(Genus_cilio_alpha_known, index = "shannon",MARGIN=2))
Group <- rep("Ciliophora",21)
cilio_biomarks_known <- cbind(cilio_div_varna_known,Group)
names(cilio_biomarks_known)[1]<-paste("Shannon")
shannon_biomarks_known <- rbind(shannon_biomarks_known,cilio_biomarks_known)

cilio_div_varna_all <- data.frame(diversity(Genus_cilio_alpha_all, index = "shannon",MARGIN=2))
Group <- rep("Ciliophora",21)
cilio_biomarks_all <- cbind(cilio_div_varna_all,Group)
...
Genus_rad_alpha_unknown <- data.frame(Genus_rad_unknown[,1:22])
rownames(Genus_rad_alpha_unknown)<-Genus_rad_alpha_unknown[,1]
Genus_rad_alpha_unknown[,1]<-NULL

Genus_known <- subset(ASV_tax_N, Genus != "Unknown")
Genus_rad_known <- Genus_known[Genus_known$Division=="Radiolaria",]
Genus_rad_alpha_known <- data.frame(Genus_rad_known[,1:22])
rownames(Genus_rad_alpha_known)<-Genus_rad_alpha_known[,1]
Genus_rad_alpha_known[,1]<-NULL

Genus_rad_all <- subset(ASV_tax_N, Division=="Radiolaria")
Genus_rad_alpha_all <- data.frame(Genus_rad_all[,1:22])
rownames(Genus_rad_alpha_all)<-Genus_rad_alpha_all[,1]
Genus_rad_alpha_all[,1]<-NULL

# Shannon diversity index 
rad_div_varna_unknown <- data.frame(diversity(Genus_rad_alpha_unknown, index = "shannon",MARGIN=2))
Group <- rep("Radiolaria",21)
rad_biomarks_unknown <- cbind(rad_div_varna_unknown,Group)
names(rad_biomarks_unknown)[1]<-paste("Shannon")
shannon_biomarks_unknown <- rbind(shannon_biomarks_unknown,rad_biomarks_unknown)

rad_div_varna_known <- rep(0,21)
Group <- rep("Radiolaria",21)
rad_biomarks_known <- data.frame(rad_div_varna_known,Group)
names(rad_biomarks_known)[1]<-paste("Shannon")
shannon_biomarks_known <- rbind(shannon_biomarks_known,rad_biomarks_known)

rad_div_varna_all <- data.frame(diversity(Genus_rad_alpha_all, index = "shannon",MARGIN=2))
Group <- rep("Radiolaria",21)
rad_biomarks_all <- cbind(rad_div_varna_all,Group)
...
abund<-0
division<-0
for (i in unique(Genus$Division)) {
  ud <- Genus[Genus$Division == i, ]
  s <- colSums(ud[,2:22])
  m <- mean(s)*100
...
df_V <- data.frame(abund,division)
...
### Shannon α-div within Dinoflagellata, Ochrophyta, Ciliophora and Radiolaria
# Keep Dino Division
Genus_dino_unknown <- Genus[Genus$Division=="Dinoflagellata",]
Genus_dino_alpha_unknown <- data.frame(Genus_dino_unknown[,1:10])
rownames(Genus_dino_alpha_unknown)<-Genus_dino_alpha_unknown[,1]
Genus_dino_alpha_unknown[,1]<-NULL

Genus_known <- subset(ASV_tax_N, Genus != "Unknown")
Genus_dino_known <- Genus_known[Genus_known$Division=="Dinoflagellata",]
Genus_dino_alpha_known <- data.frame(Genus_dino_known[,1:10])
rownames(Genus_dino_alpha_known)<-Genus_dino_alpha_known[,1]
Genus_dino_alpha_known[,1]<-NULL

Genus_dino_all <- subset(ASV_tax_N, Division=="Dinoflagellata")
Genus_dino_alpha_all <- data.frame(Genus_dino_all[,1:10])
rownames(Genus_dino_alpha_all)<-Genus_dino_alpha_all[,1]
Genus_dino_alpha_all[,1]<-NULL
...
df_class_S_barc <- data.frame((colSums(S[,2:10])/colSums(Genus_dino[,2:10]))*100)
M_S_barc <- mean(df_class_S_barc[,1])
df_class_DD_barc <- data.frame((colSums(DD[,2:10])/colSums(Genus_dino[,2:10]))*100)
M_DD_barc <- mean(df_class_DD_barc[,1])

# Quantification of known and unknowns among Syndiniales and Dinophyceae
S <- ASV_tax_N[ASV_tax_N$Class=="Syndiniales",]
DD <- ASV_tax_N[ASV_tax_N$Class=="Dinophyceae",]

K_S_barc <- S[S$Genus!="Unknown",]
K_S_barc <- mean(data.frame((colSums(K_S_barc[,2:10])/colSums(S[,2:10]))*100)[,1])
UK_S_barc <- S[S$Genus=="Unknown",]
UK_S_barc <- mean(data.frame((colSums(UK_S_barc[,2:10])/colSums(S[,2:10]))*100)[,1])

K_DD_barc <- DD[DD$Genus!="Unknown",]
K_DD_barc <- mean(data.frame(((colSums(K_DD_barc[,2:10])/colSums(DD[,2:10]))*100))[,1])
UK_DD_barc <- DD[DD$Genus=="Unknown",]
UK_DD_barc <- mean(data.frame(((colSums(UK_DD_barc[,2:10])/colSums(DD[,2:10]))*100))[,1])
#-#

# Shannon diversity index 
dino_div_barc_unknown <- data.frame(diversity(Genus_dino_alpha_unknown, index = "shannon",MARGIN=2))
Group <- rep("Dinoflagellata",9)
dino_biomarks_unknown <- cbind(dino_div_barc_unknown,Group)
names(dino_biomarks_unknown)[1]<-paste("Shannon")
shannon_biomarks_unknown <- rbind(shannon_biomarks_unknown,dino_biomarks_unknown)

dino_div_barc_known <- data.frame(diversity(Genus_dino_alpha_known, index = "shannon",MARGIN=2))
Group <- rep("Dinoflagellata",9)
dino_biomarks_known <- cbind(dino_div_barc_known,Group)
names(dino_biomarks_known)[1]<-paste("Shannon")
shannon_biomarks_known <- rbind(shannon_biomarks_known,dino_biomarks_known)

dino_div_barc_all <- data.frame(diversity(Genus_dino_alpha_all, index = "shannon",MARGIN=2))
Group <- rep("Dinoflagellata",9)
dino_biomarks_all <- cbind(dino_div_barc_all,Group)
names(dino_biomarks_all)[1]<-paste("Shannon")
shannon_biomarks_all <- rbind(shannon_biomarks_all,dino_biomarks_all)

# Keep Ochro Division
Genus_ochro_unknown <- Genus[Genus$Division=="Ochrophyta",]
Genus_ochro_alpha_unknown <- data.frame(Genus_ochro_unknown[,1:10])
rownames(Genus_ochro_alpha_unknown)<-Genus_ochro_alpha_unknown[,1]
Genus_ochro_alpha_unknown[,1]<-NULL

Genus_known <- subset(ASV_tax_N, Genus != "Unknown")
Genus_ochro_known <- Genus_known[Genus_known$Division=="Ochrophyta",]
Genus_ochro_alpha_known <- data.frame(Genus_ochro_known[,1:10])
rownames(Genus_ochro_alpha_known)<-Genus_ochro_alpha_known[,1]
Genus_ochro_alpha_known[,1]<-NULL

Genus_ochro_all <- subset(ASV_tax_N, Division=="Ochrophyta")
Genus_ochro_alpha_all <- data.frame(Genus_ochro_all[,1:10])
rownames(Genus_ochro_alpha_all)<-Genus_ochro_alpha_all[,1]
Genus_ochro_alpha_all[,1]<-NULL

# Shannon diversity index 
ochro_div_barc_unknown <- data.frame(diversity(Genus_ochro_alpha_unknown, index = "shannon",MARGIN=2))
Group <- rep("Ochrophyta",9)
ochro_biomarks_unknown <- cbind(ochro_div_barc_unknown,Group)
names(ochro_biomarks_unknown)[1]<-paste("Shannon")
shannon_biomarks_unknown <- rbind(shannon_biomarks_unknown,ochro_biomarks_unknown)

ochro_div_barc_known <- data.frame(diversity(Genus_ochro_alpha_known, index = "shannon",MARGIN=2))
Group <- rep("Ochrophyta",9)
ochro_biomarks_known <- cbind(ochro_div_barc_known,Group)
names(ochro_biomarks_known)[1]<-paste("Shannon")
shannon_biomarks_known <- rbind(shannon_biomarks_known,ochro_biomarks_known)

ochro_div_barc_all <- data.frame(diversity(Genus_ochro_alpha_all, index = "shannon",MARGIN=2))
Group <- rep("Ochrophyta",9)
ochro_biomarks_all <- cbind(ochro_div_barc_all,Group)
names(ochro_biomarks_all)[1]<-paste("Shannon")
shannon_biomarks_all <- rbind(shannon_biomarks_all,ochro_biomarks_all)

# Keep Cilio Division
Genus_cilio_unknown <- Genus[Genus$Division=="Ciliophora",]
Genus_cilio_alpha_unknown <- data.frame(Genus_cilio_unknown[,1:10])
rownames(Genus_cilio_alpha_unknown)<-Genus_cilio_alpha_unknown[,1]
Genus_cilio_alpha_unknown[,1]<-NULL

Genus_known <- subset(ASV_tax_N, Genus != "Unknown")
Genus_cilio_known <- Genus_known[Genus_known$Division=="Ciliophora",]
Genus_cilio_alpha_known <- data.frame(Genus_cilio_known[,1:10])
rownames(Genus_cilio_alpha_known)<-Genus_cilio_alpha_known[,1]
Genus_cilio_alpha_known[,1]<-NULL

Genus_cilio_all <- subset(ASV_tax_N, Division=="Ciliophora")
Genus_cilio_alpha_all <- data.frame(Genus_cilio_all[,1:10])
rownames(Genus_cilio_alpha_all)<-Genus_cilio_alpha_all[,1]
Genus_cilio_alpha_all[,1]<-NULL

# Shannon diversity index 
cilio_div_barc_unknown <- data.frame(diversity(Genus_cilio_alpha_unknown, index = "shannon",MARGIN=2))
Group <- rep("Ciliophora",9)
cilio_biomarks_unknown <- cbind(cilio_div_barc_unknown,Group)
names(cilio_biomarks_unknown)[1]<-paste("Shannon")
shannon_biomarks_unknown <- rbind(shannon_biomarks_unknown,cilio_biomarks_unknown)

cilio_div_barc_known <- data.frame(diversity(Genus_cilio_alpha_known, index = "shannon",MARGIN=2))
Group <- rep("Ciliophora",9)
cilio_biomarks_known <- cbind(cilio_div_barc_known,Group)
names(cilio_biomarks_known)[1]<-paste("Shannon")
shannon_biomarks_known <- rbind(shannon_biomarks_known,cilio_biomarks_known)

cilio_div_barc_all <- data.frame(diversity(Genus_cilio_alpha_all, index = "shannon",MARGIN=2))
Group <- rep("Ciliophora",9)
cilio_biomarks_all <- cbind(cilio_div_barc_all,Group)
names(cilio_biomarks_all)[1]<-paste("Shannon")
shannon_biomarks_all <- rbind(shannon_biomarks_all,cilio_biomarks_all)

# Keep Rad Division
Genus_rad_unknown <- Genus[Genus$Division=="Radiolaria",]
Genus_rad_alpha_unknown <- data.frame(Genus_rad_unknown[,1:10])
rownames(Genus_rad_alpha_unknown)<-Genus_rad_alpha_unknown[,1]
Genus_rad_alpha_unknown[,1]<-NULL

Genus_known <- subset(ASV_tax_N, Genus != "Unknown")
Genus_rad_known <- Genus_known[Genus_known$Division=="Radiolaria",]
Genus_rad_alpha_known <- data.frame(Genus_rad_known[,1:10])
rownames(Genus_rad_alpha_known)<-Genus_rad_alpha_known[,1]
Genus_rad_alpha_known[,1]<-NULL

Genus_rad_all <- subset(ASV_tax_N, Division=="Radiolaria")
Genus_rad_alpha_all <- data.frame(Genus_rad_all[,1:10])
rownames(Genus_rad_alpha_all)<-Genus_rad_alpha_all[,1]
Genus_rad_alpha_all[,1]<-NULL

# Shannon diversity index 
rad_div_barc_unknown <- data.frame(diversity(Genus_rad_alpha_unknown, index = "shannon",MARGIN=2))
Group <- rep("Radiolaria",9)
rad_biomarks_unknown <- cbind(rad_div_barc_unknown,Group)
names(rad_biomarks_unknown)[1]<-paste("Shannon")
shannon_biomarks_unknown <- rbind(shannon_biomarks_unknown,rad_biomarks_unknown)

rad_div_barc_known <- data.frame(diversity(Genus_rad_alpha_known, index = "shannon",MARGIN=2))
Group <- rep("Radiolaria",9)
rad_biomarks_known <- cbind(rad_div_barc_known,Group)
names(rad_biomarks_known)[1]<-paste("Shannon")
shannon_biomarks_known <- rbind(shannon_biomarks_known,rad_biomarks_known)

rad_div_barc_all <- data.frame(diversity(Genus_rad_alpha_all, index = "shannon",MARGIN=2))
Group <- rep("Radiolaria",9)
rad_biomarks_all <- cbind(rad_div_barc_all,Group)
names(rad_biomarks_all)[1]<-paste("Shannon")
shannon_biomarks_all <- rbind(shannon_biomarks_all,rad_biomarks_all)
###
...
df_B <- data.frame(abund,division)
...
# Read abundance table
t=read.csv("/shared/projects/formaldark/datasets/Biomarks/omics/ASV_Biom_Gijon_filt_PR2_f200.csv",h=T, sep=";")
...
# Keep Dino Division
Genus_dino_unknown <- Genus[Genus$Division=="Dinoflagellata",]
Genus_dino_alpha_unknown <- data.frame(Genus_dino_unknown[,1:5])
rownames(Genus_dino_alpha_unknown)<-Genus_dino_alpha_unknown[,1]
Genus_dino_alpha_unknown[,1]<-NULL

Genus_known <- subset(ASV_tax_N, Genus != "Unknown")
Genus_dino_known <- Genus_known[Genus_known$Division=="Dinoflagellata",]
Genus_dino_alpha_known <- data.frame(Genus_dino_known[,1:5])
rownames(Genus_dino_alpha_known)<-Genus_dino_alpha_known[,1]
Genus_dino_alpha_known[,1]<-NULL

Genus_dino_all <- subset(ASV_tax_N, Division=="Dinoflagellata")
Genus_dino_alpha_all <- data.frame(Genus_dino_all[,1:5])
rownames(Genus_dino_alpha_all)<-Genus_dino_alpha_all[,1]
Genus_dino_alpha_all[,1]<-NULL
...
df_class_S_gij <- data.frame((colSums(S[,2:5])/colSums(Genus_dino[,2:5]))*100)
M_S_gij <- mean(df_class_S_gij[,1])
df_class_DD_gij <- data.frame((colSums(DD[,2:5])/colSums(Genus_dino[,2:5]))*100)
M_DD_gij <- mean(df_class_DD_gij[,1])

# Quantification of known and unknowns among Syndiniales and Dinophyceae
S <- ASV_tax_N[ASV_tax_N$Class=="Syndiniales",]
DD <- ASV_tax_N[ASV_tax_N$Class=="Dinophyceae",]

K_S_gij <- S[S$Genus!="Unknown",]
K_S_gij <- mean(data.frame((colSums(K_S_gij[,2:5])/colSums(S[,2:5]))*100)[,1])
UK_S_gij <- S[S$Genus=="Unknown",]
UK_S_gij <- mean(data.frame((colSums(UK_S_gij[,2:5])/colSums(S[,2:5]))*100)[,1])

K_DD_gij <- DD[DD$Genus!="Unknown",]
K_DD_gij <- mean(data.frame(((colSums(K_DD_gij[,2:5])/colSums(DD[,2:5]))*100))[,1])
UK_DD_gij <- DD[DD$Genus=="Unknown",]
UK_DD_gij <- mean(data.frame(((colSums(UK_DD_gij[,2:5])/colSums(DD[,2:5]))*100))[,1])
#-#

# Shannon diversity index 
dino_div_gij_unknown <- data.frame(diversity(Genus_dino_alpha_unknown, index = "shannon",MARGIN=2))
Group <- rep("Dinoflagellata",4)
dino_biomarks_unknown <- cbind(dino_div_gij_unknown,Group)
names(dino_biomarks_unknown)[1]<-paste("Shannon")
shannon_biomarks_unknown <- rbind(shannon_biomarks_unknown,dino_biomarks_unknown)

dino_div_gij_known <- data.frame(diversity(Genus_dino_alpha_known, index = "shannon",MARGIN=2))
Group <- rep("Dinoflagellata",4)
dino_biomarks_known <- cbind(dino_div_gij_known,Group)
names(dino_biomarks_known)[1]<-paste("Shannon")
shannon_biomarks_known <- rbind(shannon_biomarks_known,dino_biomarks_known)

dino_div_gij_all <- data.frame(diversity(Genus_dino_alpha_all, index = "shannon",MARGIN=2))
Group <- rep("Dinoflagellata",4)
dino_biomarks_all <- cbind(dino_div_gij_all,Group)
names(dino_biomarks_all)[1]<-paste("Shannon")
shannon_biomarks_all <- rbind(shannon_biomarks_all,dino_biomarks_all)

# Keep Ochro Division
Genus_ochro_unknown <- Genus[Genus$Division=="Ochrophyta",]
Genus_ochro_alpha_unknown <- data.frame(Genus_ochro_unknown[,1:5])
rownames(Genus_ochro_alpha_unknown)<-Genus_ochro_alpha_unknown[,1]
Genus_ochro_alpha_unknown[,1]<-NULL

Genus_known <- subset(ASV_tax_N, Genus != "Unknown")
Genus_ochro_known <- Genus_known[Genus_known$Division=="Ochrophyta",]
Genus_ochro_alpha_known <- data.frame(Genus_ochro_known[,1:5])
rownames(Genus_ochro_alpha_known)<-Genus_ochro_alpha_known[,1]
Genus_ochro_alpha_known[,1]<-NULL

Genus_ochro_all <- subset(ASV_tax_N, Division=="Ochrophyta")
Genus_ochro_alpha_all <- data.frame(Genus_ochro_all[,1:5])
rownames(Genus_ochro_alpha_all)<-Genus_ochro_alpha_all[,1]
Genus_ochro_alpha_all[,1]<-NULL

# Shannon diversity index 
ochro_div_gij_unknown <- data.frame(diversity(Genus_ochro_alpha_unknown, index = "shannon",MARGIN=2))
Group <- rep("Ochrophyta",4)
ochro_biomarks_unknown <- cbind(ochro_div_gij_unknown,Group)
names(ochro_biomarks_unknown)[1]<-paste("Shannon")
shannon_biomarks_unknown <- rbind(shannon_biomarks_unknown,ochro_biomarks_unknown)

ochro_div_gij_known <- data.frame(diversity(Genus_ochro_alpha_known, index = "shannon",MARGIN=2))
Group <- rep("Ochrophyta",4)
ochro_biomarks_known <- cbind(ochro_div_gij_known,Group)
names(ochro_biomarks_known)[1]<-paste("Shannon")
shannon_biomarks_known <- rbind(shannon_biomarks_known,ochro_biomarks_known)

ochro_div_gij_all <- data.frame(diversity(Genus_ochro_alpha_all, index = "shannon",MARGIN=2))
Group <- rep("Ochrophyta",4)
ochro_biomarks_all <- cbind(ochro_div_gij_all,Group)
names(ochro_biomarks_all)[1]<-paste("Shannon")
shannon_biomarks_all <- rbind(shannon_biomarks_all,ochro_biomarks_all)

# Keep Cilio Division
Genus_cilio_unknown <- Genus[Genus$Division=="Ciliophora",]
Genus_cilio_alpha_unknown <- data.frame(Genus_cilio_unknown[,1:5])
rownames(Genus_cilio_alpha_unknown)<-Genus_cilio_alpha_unknown[,1]
Genus_cilio_alpha_unknown[,1]<-NULL

Genus_known <- subset(ASV_tax_N, Genus != "Unknown")
Genus_cilio_known <- Genus_known[Genus_known$Division=="Ciliophora",]
Genus_cilio_alpha_known <- data.frame(Genus_cilio_known[,1:5])
rownames(Genus_cilio_alpha_known)<-Genus_cilio_alpha_known[,1]
Genus_cilio_alpha_known[,1]<-NULL

Genus_cilio_all <- subset(ASV_tax_N, Division=="Ciliophora")
Genus_cilio_alpha_all <- data.frame(Genus_cilio_all[,1:5])
rownames(Genus_cilio_alpha_all)<-Genus_cilio_alpha_all[,1]
Genus_cilio_alpha_all[,1]<-NULL

# Shannon diversity index 
cilio_div_gij_unknown <- data.frame(diversity(Genus_cilio_alpha_unknown, index = "shannon",MARGIN=2))
Group <- rep("Ciliophora",4)
cilio_biomarks_unknown <- cbind(cilio_div_gij_unknown,Group)
names(cilio_biomarks_unknown)[1]<-paste("Shannon")
shannon_biomarks_unknown <- rbind(shannon_biomarks_unknown,cilio_biomarks_unknown)

cilio_div_gij_known <- data.frame(diversity(Genus_cilio_alpha_known, index = "shannon",MARGIN=2))
Group <- rep("Ciliophora",4)
cilio_biomarks_known <- cbind(cilio_div_gij_known,Group)
names(cilio_biomarks_known)[1]<-paste("Shannon")
shannon_biomarks_known <- rbind(shannon_biomarks_known,cilio_biomarks_known)

cilio_div_gij_all <- data.frame(diversity(Genus_cilio_alpha_all, index = "shannon",MARGIN=2))
Group <- rep("Ciliophora",4)
cilio_biomarks_all <- cbind(cilio_div_gij_all,Group)
names(cilio_biomarks_all)[1]<-paste("Shannon")
shannon_biomarks_all <- rbind(shannon_biomarks_all,cilio_biomarks_all)

# Keep Rad Division
Genus_rad_unknown <- Genus[Genus$Division=="Radiolaria",]
Genus_rad_alpha_unknown <- data.frame(Genus_rad_unknown[,1:5])
rownames(Genus_rad_alpha_unknown)<-Genus_rad_alpha_unknown[,1]
Genus_rad_alpha_unknown[,1]<-NULL

Genus_known <- subset(ASV_tax_N, Genus != "Unknown")
Genus_rad_known <- Genus_known[Genus_known$Division=="Radiolaria",]
Genus_rad_alpha_known <- data.frame(Genus_rad_known[,1:5])
rownames(Genus_rad_alpha_known)<-Genus_rad_alpha_known[,1]
Genus_rad_alpha_known[,1]<-NULL

Genus_rad_all <- subset(ASV_tax_N, Division=="Radiolaria")
Genus_rad_alpha_all <- data.frame(Genus_rad_all[,1:5])
rownames(Genus_rad_alpha_all)<-Genus_rad_alpha_all[,1]
Genus_rad_alpha_all[,1]<-NULL

# Shannon diversity index 
rad_div_gij_unknown <- data.frame(diversity(Genus_rad_alpha_unknown, index = "shannon",MARGIN=2))
Group <- rep("Radiolaria",4)
rad_biomarks_unknown <- cbind(rad_div_gij_unknown,Group)
names(rad_biomarks_unknown)[1]<-paste("Shannon")
shannon_biomarks_unknown <- rbind(shannon_biomarks_unknown,rad_biomarks_unknown)

rad_div_gij_known <- data.frame(diversity(Genus_rad_alpha_known, index = "shannon",MARGIN=2))
Group <- rep("Radiolaria",4)
rad_biomarks_known <- cbind(rad_div_gij_known,Group)
names(rad_biomarks_known)[1]<-paste("Shannon")
shannon_biomarks_known <- rbind(shannon_biomarks_known,rad_biomarks_known)

rad_div_gij_all <- data.frame(diversity(Genus_rad_alpha_all, index = "shannon",MARGIN=2))
Group <- rep("Radiolaria",4)
rad_biomarks_all <- cbind(rad_div_gij_all,Group)
names(rad_biomarks_all)[1]<-paste("Shannon")
shannon_biomarks_all <- rbind(shannon_biomarks_all,rad_biomarks_all)
###
...
df_G <- data.frame(abund,division)
...
# Keep Dino Division
Genus_dino_unknown <- Genus[Genus$Division=="Dinoflagellata",]
Genus_dino_alpha_unknown <- data.frame(Genus_dino_unknown[,1:41])
rownames(Genus_dino_alpha_unknown)<-Genus_dino_alpha_unknown[,1]
Genus_dino_alpha_unknown[,1]<-NULL

Genus_known <- subset(ASV_tax_N, Genus != "Unknown")
Genus_dino_known <- Genus_known[Genus_known$Division=="Dinoflagellata",]
Genus_dino_alpha_known <- data.frame(Genus_dino_known[,1:41])
rownames(Genus_dino_alpha_known)<-Genus_dino_alpha_known[,1]
Genus_dino_alpha_known[,1]<-NULL

Genus_dino_all <- subset(ASV_tax_N, Division=="Dinoflagellata")
Genus_dino_alpha_all <- data.frame(Genus_dino_all[,1:41])
rownames(Genus_dino_alpha_all)<-Genus_dino_alpha_all[,1]
Genus_dino_alpha_all[,1]<-NULL
...
df_class_S_napl <- data.frame((colSums(S[,2:41])/colSums(Genus_dino[,2:41]))*100)
M_S_napl <- mean(df_class_S_napl[,1])
df_class_DD_napl <- data.frame((colSums(DD[,2:41])/colSums(Genus_dino[,2:41]))*100)
M_DD_napl <- mean(df_class_DD_napl[,1])

# Quantification of known and unknowns among Syndiniales and Dinophyceae
S <- ASV_tax_N[ASV_tax_N$Class=="Syndiniales",]
DD <- ASV_tax_N[ASV_tax_N$Class=="Dinophyceae",]

K_S_napl <- S[S$Genus!="Unknown",]
K_S_napl <- mean(data.frame((colSums(K_S_napl[,2:41])/colSums(S[,2:41]))*100)[,1])
UK_S_napl <- S[S$Genus=="Unknown",]
UK_S_napl <- mean(data.frame((colSums(UK_S_napl[,2:41])/colSums(S[,2:41]))*100)[,1])

K_DD_napl <- DD[DD$Genus!="Unknown",]
K_DD_napl <- mean(data.frame(((colSums(K_DD_napl[,2:41])/colSums(DD[,2:41]))*100))[,1])
UK_DD_napl <- DD[DD$Genus=="Unknown",]
UK_DD_napl <- mean(data.frame(((colSums(UK_DD_napl[,2:41])/colSums(DD[,2:41]))*100))[,1])
#-#

# Shannon diversity index 
dino_div_napl_unknown <- data.frame(diversity(Genus_dino_alpha_unknown, index = "shannon",MARGIN=2))
Group <- rep("Dinoflagellata",40)
dino_biomarks_unknown <- cbind(dino_div_napl_unknown,Group)
names(dino_biomarks_unknown)[1]<-paste("Shannon")
shannon_biomarks_unknown <- rbind(shannon_biomarks_unknown,dino_biomarks_unknown)

dino_div_napl_known <- data.frame(diversity(Genus_dino_alpha_known, index = "shannon",MARGIN=2))
Group <- rep("Dinoflagellata",40)
dino_biomarks_known <- cbind(dino_div_napl_known,Group)
names(dino_biomarks_known)[1]<-paste("Shannon")
shannon_biomarks_known <- rbind(shannon_biomarks_known,dino_biomarks_known)

dino_div_napl_all <- data.frame(diversity(Genus_dino_alpha_all, index = "shannon",MARGIN=2))
Group <- rep("Dinoflagellata",40)
dino_biomarks_all <- cbind(dino_div_napl_all,Group)
names(dino_biomarks_all)[1]<-paste("Shannon")
shannon_biomarks_all <- rbind(shannon_biomarks_all,dino_biomarks_all)

# Keep Ochro Division
Genus_ochro_unknown <- Genus[Genus$Division=="Ochrophyta",]
Genus_ochro_alpha_unknown <- data.frame(Genus_ochro_unknown[,1:41])
rownames(Genus_ochro_alpha_unknown)<-Genus_ochro_alpha_unknown[,1]
Genus_ochro_alpha_unknown[,1]<-NULL

Genus_known <- subset(ASV_tax_N, Genus != "Unknown")
Genus_ochro_known <- Genus_known[Genus_known$Division=="Ochrophyta",]
Genus_ochro_alpha_known <- data.frame(Genus_ochro_known[,1:41])
rownames(Genus_ochro_alpha_known)<-Genus_ochro_alpha_known[,1]
Genus_ochro_alpha_known[,1]<-NULL

Genus_ochro_all <- subset(ASV_tax_N, Division=="Ochrophyta")
Genus_ochro_alpha_all <- data.frame(Genus_ochro_all[,1:41])
rownames(Genus_ochro_alpha_all)<-Genus_ochro_alpha_all[,1]
Genus_ochro_alpha_all[,1]<-NULL

# Shannon diversity index 
ochro_div_napl_unknown <- data.frame(diversity(Genus_ochro_alpha_unknown, index = "shannon",MARGIN=2))
Group <- rep("Ochrophyta",40)
ochro_biomarks_unknown <- cbind(ochro_div_napl_unknown,Group)
names(ochro_biomarks_unknown)[1]<-paste("Shannon")
shannon_biomarks_unknown <- rbind(shannon_biomarks_unknown,ochro_biomarks_unknown)

ochro_div_napl_known <- data.frame(diversity(Genus_ochro_alpha_known, index = "shannon",MARGIN=2))
Group <- rep("Ochrophyta",40)
ochro_biomarks_known <- cbind(ochro_div_napl_known,Group)
names(ochro_biomarks_known)[1]<-paste("Shannon")
shannon_biomarks_known <- rbind(shannon_biomarks_known,ochro_biomarks_known)

ochro_div_napl_all <- data.frame(diversity(Genus_ochro_alpha_all, index = "shannon",MARGIN=2))
Group <- rep("Ochrophyta",40)
ochro_biomarks_all <- cbind(ochro_div_napl_all,Group)
names(ochro_biomarks_all)[1]<-paste("Shannon")
shannon_biomarks_all <- rbind(shannon_biomarks_all,ochro_biomarks_all)

# Keep Cilio Division
Genus_cilio_unknown <- Genus[Genus$Division=="Ciliophora",]
Genus_cilio_alpha_unknown <- data.frame(Genus_cilio_unknown[,1:41])
rownames(Genus_cilio_alpha_unknown)<-Genus_cilio_alpha_unknown[,1]
Genus_cilio_alpha_unknown[,1]<-NULL

Genus_known <- subset(ASV_tax_N, Genus != "Unknown")
Genus_cilio_known <- Genus_known[Genus_known$Division=="Ciliophora",]
Genus_cilio_alpha_known <- data.frame(Genus_cilio_known[,1:41])
rownames(Genus_cilio_alpha_known)<-Genus_cilio_alpha_known[,1]
Genus_cilio_alpha_known[,1]<-NULL

Genus_cilio_all <- subset(ASV_tax_N, Division=="Ciliophora")
Genus_cilio_alpha_all <- data.frame(Genus_cilio_all[,1:41])
rownames(Genus_cilio_alpha_all)<-Genus_cilio_alpha_all[,1]
Genus_cilio_alpha_all[,1]<-NULL

# Shannon diversity index 
cilio_div_napl_unknown <- data.frame(diversity(Genus_cilio_alpha_unknown, index = "shannon",MARGIN=2))
Group <- rep("Ciliophora",40)
cilio_biomarks_unknown <- cbind(cilio_div_napl_unknown,Group)
names(cilio_biomarks_unknown)[1]<-paste("Shannon")
shannon_biomarks_unknown <- rbind(shannon_biomarks_unknown,cilio_biomarks_unknown)

cilio_div_napl_known <- data.frame(diversity(Genus_cilio_alpha_known, index = "shannon",MARGIN=2))
Group <- rep("Ciliophora",40)
cilio_biomarks_known <- cbind(cilio_div_napl_known,Group)
names(cilio_biomarks_known)[1]<-paste("Shannon")
shannon_biomarks_known <- rbind(shannon_biomarks_known,cilio_biomarks_known)

cilio_div_napl_all <- data.frame(diversity(Genus_cilio_alpha_all, index = "shannon",MARGIN=2))
Group <- rep("Ciliophora",40)
cilio_biomarks_all <- cbind(cilio_div_napl_all,Group)
names(cilio_biomarks_all)[1]<-paste("Shannon")
shannon_biomarks_all <- rbind(shannon_biomarks_all,cilio_biomarks_all)

# Keep Rad Division
Genus_rad_unknown <- Genus[Genus$Division=="Radiolaria",]
Genus_rad_alpha_unknown <- data.frame(Genus_rad_unknown[,1:41])
rownames(Genus_rad_alpha_unknown)<-Genus_rad_alpha_unknown[,1]
Genus_rad_alpha_unknown[,1]<-NULL

Genus_known <- subset(ASV_tax_N, Genus != "Unknown")
Genus_rad_known <- Genus_known[Genus_known$Division=="Radiolaria",]
Genus_rad_alpha_known <- data.frame(Genus_rad_known[,1:41])
rownames(Genus_rad_alpha_known)<-Genus_rad_alpha_known[,1]
Genus_rad_alpha_known[,1]<-NULL

Genus_rad_all <- subset(ASV_tax_N, Division=="Radiolaria")
Genus_rad_alpha_all <- data.frame(Genus_rad_all[,1:41])
rownames(Genus_rad_alpha_all)<-Genus_rad_alpha_all[,1]
Genus_rad_alpha_all[,1]<-NULL

# Shannon diversity index 
rad_div_napl_unknown <- data.frame(diversity(Genus_rad_alpha_unknown, index = "shannon",MARGIN=2))
Group <- rep("Radiolaria",40)
rad_biomarks_unknown <- cbind(rad_div_napl_unknown,Group)
names(rad_biomarks_unknown)[1]<-paste("Shannon")
shannon_biomarks_unknown <- rbind(shannon_biomarks_unknown,rad_biomarks_unknown)

rad_div_napl_known <- data.frame(diversity(Genus_rad_alpha_known, index = "shannon",MARGIN=2))
Group <- rep("Radiolaria",40)
rad_biomarks_known <- cbind(rad_div_napl_known,Group)
names(rad_biomarks_known)[1]<-paste("Shannon")
shannon_biomarks_known <- rbind(shannon_biomarks_known,rad_biomarks_known)

rad_div_napl_all <- data.frame(diversity(Genus_rad_alpha_all, index = "shannon",MARGIN=2))
Group <- rep("Radiolaria",40)
rad_biomarks_all <- cbind(rad_div_napl_all,Group)
names(rad_biomarks_all)[1]<-paste("Shannon")
shannon_biomarks_all <- rbind(shannon_biomarks_all,rad_biomarks_all)
###
...
df_N <- data.frame(abund,division)
...
# Keep Dino Division
Genus_dino_unknown <- Genus[Genus$Division=="Dinoflagellata",]
Genus_dino_alpha_unknown <- data.frame(Genus_dino_unknown[,1:8])
rownames(Genus_dino_alpha_unknown)<-Genus_dino_alpha_unknown[,1]
Genus_dino_alpha_unknown[,1]<-NULL

Genus_known <- subset(ASV_tax_N, Genus != "Unknown")
Genus_dino_known <- Genus_known[Genus_known$Division=="Dinoflagellata",]
Genus_dino_alpha_known <- data.frame(Genus_dino_known[,1:8])
rownames(Genus_dino_alpha_known)<-Genus_dino_alpha_known[,1]
Genus_dino_alpha_known[,1]<-NULL

Genus_dino_all <- subset(ASV_tax_N, Division=="Dinoflagellata")
Genus_dino_alpha_all <- data.frame(Genus_dino_all[,1:8])
rownames(Genus_dino_alpha_all)<-Genus_dino_alpha_all[,1]
Genus_dino_alpha_all[,1]<-NULL
...
df_class_S_rosc <- data.frame((colSums(S[,2:8])/colSums(Genus_dino[,2:8]))*100)
M_S_rosc <- mean(df_class_S_rosc[,1])
df_class_DD_rosc <- data.frame((colSums(DD[,2:8])/colSums(Genus_dino[,2:8]))*100)
M_DD_rosc <- mean(df_class_DD_rosc[,1])

# Quantification of known and unknowns among Syndiniales and Dinophyceae
S <- ASV_tax_N[ASV_tax_N$Class=="Syndiniales",]
DD <- ASV_tax_N[ASV_tax_N$Class=="Dinophyceae",]

K_S_rosc <- S[S$Genus!="Unknown",]
K_S_rosc <-  mean(data.frame((colSums(K_S_rosc[,2:8])/colSums(S[,2:8]))*100)[,1])
UK_S_rosc <- S[S$Genus=="Unknown",]
UK_S_rosc <- mean(data.frame((colSums(UK_S_rosc[,2:8])/colSums(S[,2:8]))*100)[,1])

K_DD_rosc <- DD[DD$Genus!="Unknown",]
K_DD_rosc <- mean(data.frame(((colSums(K_DD_rosc[,2:8])/colSums(DD[,2:8]))*100))[,1])
UK_DD_rosc <- DD[DD$Genus=="Unknown",]
UK_DD_rosc <- mean(data.frame(((colSums(UK_DD_rosc[,2:8])/colSums(DD[,2:8]))*100))[,1])
#-#

# Shannon diversity index 
dino_div_rosc_unknown <- data.frame(diversity(Genus_dino_alpha_unknown, index = "shannon",MARGIN=2))
Group <- rep("Dinoflagellata",7)
dino_biomarks_unknown <- cbind(dino_div_rosc_unknown,Group)
names(dino_biomarks_unknown)[1]<-paste("Shannon")
shannon_biomarks_unknown <- rbind(shannon_biomarks_unknown,dino_biomarks_unknown)

dino_div_rosc_known <- data.frame(diversity(Genus_dino_alpha_known, index = "shannon",MARGIN=2))
Group <- rep("Dinoflagellata",7)
dino_biomarks_known <- cbind(dino_div_rosc_known,Group)
names(dino_biomarks_known)[1]<-paste("Shannon")
shannon_biomarks_known <- rbind(shannon_biomarks_known,dino_biomarks_known)

dino_div_rosc_all <- data.frame(diversity(Genus_dino_alpha_all, index = "shannon",MARGIN=2))
Group <- rep("Dinoflagellata",7)
dino_biomarks_all <- cbind(dino_div_rosc_all,Group)
names(dino_biomarks_all)[1]<-paste("Shannon")
shannon_biomarks_all <- rbind(shannon_biomarks_all,dino_biomarks_all)

# Keep Ochro Division
Genus_ochro_unknown <- Genus[Genus$Division=="Ochrophyta",]
Genus_ochro_alpha_unknown <- data.frame(Genus_ochro_unknown[,1:8])
rownames(Genus_ochro_alpha_unknown)<-Genus_ochro_alpha_unknown[,1]
Genus_ochro_alpha_unknown[,1]<-NULL

Genus_known <- subset(ASV_tax_N, Genus != "Unknown")
Genus_ochro_known <- Genus_known[Genus_known$Division=="Ochrophyta",]
Genus_ochro_alpha_known <- data.frame(Genus_ochro_known[,1:8])
rownames(Genus_ochro_alpha_known)<-Genus_ochro_alpha_known[,1]
Genus_ochro_alpha_known[,1]<-NULL

Genus_ochro_all <- subset(ASV_tax_N, Division=="Ochrophyta")
Genus_ochro_alpha_all <- data.frame(Genus_ochro_all[,1:8])
rownames(Genus_ochro_alpha_all)<-Genus_ochro_alpha_all[,1]
Genus_ochro_alpha_all[,1]<-NULL

# Shannon diversity index 
ochro_div_rosc_unknown <- data.frame(diversity(Genus_ochro_alpha_unknown, index = "shannon",MARGIN=2))
Group <- rep("Ochrophyta",7)
ochro_biomarks_unknown <- cbind(ochro_div_rosc_unknown,Group)
names(ochro_biomarks_unknown)[1]<-paste("Shannon")
shannon_biomarks_unknown <- rbind(shannon_biomarks_unknown,ochro_biomarks_unknown)

ochro_div_rosc_known <- data.frame(diversity(Genus_ochro_alpha_known, index = "shannon",MARGIN=2))
Group <- rep("Ochrophyta",7)
ochro_biomarks_known <- cbind(ochro_div_rosc_known,Group)
names(ochro_biomarks_known)[1]<-paste("Shannon")
shannon_biomarks_known <- rbind(shannon_biomarks_known,ochro_biomarks_known)

ochro_div_rosc_all <- data.frame(diversity(Genus_ochro_alpha_all, index = "shannon",MARGIN=2))
Group <- rep("Ochrophyta",7)
ochro_biomarks_all <- cbind(ochro_div_rosc_all,Group)
names(ochro_biomarks_all)[1]<-paste("Shannon")
shannon_biomarks_all <- rbind(shannon_biomarks_all,ochro_biomarks_all)

# Keep Cilio Division
Genus_cilio_unknown <- Genus[Genus$Division=="Ciliophora",]
Genus_cilio_alpha_unknown <- data.frame(Genus_cilio_unknown[,1:8])
rownames(Genus_cilio_alpha_unknown)<-Genus_cilio_alpha_unknown[,1]
Genus_cilio_alpha_unknown[,1]<-NULL

Genus_known <- subset(ASV_tax_N, Genus != "Unknown")
Genus_cilio_known <- Genus_known[Genus_known$Division=="Ciliophora",]
Genus_cilio_alpha_known <- data.frame(Genus_cilio_known[,1:8])
rownames(Genus_cilio_alpha_known)<-Genus_cilio_alpha_known[,1]
Genus_cilio_alpha_known[,1]<-NULL

Genus_cilio_all <- subset(ASV_tax_N, Division=="Ciliophora")
Genus_cilio_alpha_all <- data.frame(Genus_cilio_all[,1:8])
rownames(Genus_cilio_alpha_all)<-Genus_cilio_alpha_all[,1]
Genus_cilio_alpha_all[,1]<-NULL

# Shannon diversity index 
cilio_div_rosc_unknown <- data.frame(diversity(Genus_cilio_alpha_unknown, index = "shannon",MARGIN=2))
Group <- rep("Ciliophora",7)
cilio_biomarks_unknown <- cbind(cilio_div_rosc_unknown,Group)
names(cilio_biomarks_unknown)[1]<-paste("Shannon")
shannon_biomarks_unknown <- rbind(shannon_biomarks_unknown,cilio_biomarks_unknown)

cilio_div_rosc_known <- data.frame(diversity(Genus_cilio_alpha_known, index = "shannon",MARGIN=2))
Group <- rep("Ciliophora",7)
cilio_biomarks_known <- cbind(cilio_div_rosc_known,Group)
names(cilio_biomarks_known)[1]<-paste("Shannon")
shannon_biomarks_known <- rbind(shannon_biomarks_known,cilio_biomarks_known)

cilio_div_rosc_all <- data.frame(diversity(Genus_cilio_alpha_all, index = "shannon",MARGIN=2))
Group <- rep("Ciliophora",7)
cilio_biomarks_all <- cbind(cilio_div_rosc_all,Group)
names(cilio_biomarks_all)[1]<-paste("Shannon")
shannon_biomarks_all <- rbind(shannon_biomarks_all,cilio_biomarks_all)

# Keep Rad Division
Genus_rad_unknown <- Genus[Genus$Division=="Radiolaria",]
Genus_rad_alpha_unknown <- data.frame(Genus_rad_unknown[,1:8])
rownames(Genus_rad_alpha_unknown)<-Genus_rad_alpha_unknown[,1]
Genus_rad_alpha_unknown[,1]<-NULL

Genus_known <- subset(ASV_tax_N, Genus != "Unknown")
Genus_rad_known <- Genus_known[Genus_known$Division=="Radiolaria",]
Genus_rad_alpha_known <- data.frame(Genus_rad_known[,1:8])
rownames(Genus_rad_alpha_known)<-Genus_rad_alpha_known[,1]
Genus_rad_alpha_known[,1]<-NULL

Genus_rad_all <- subset(ASV_tax_N, Division=="Radiolaria")
Genus_rad_alpha_all <- data.frame(Genus_rad_all[,1:8])
rownames(Genus_rad_alpha_all)<-Genus_rad_alpha_all[,1]
Genus_rad_alpha_all[,1]<-NULL

# Shannon diversity index 
rad_div_rosc_unknown <- data.frame(diversity(Genus_rad_alpha_unknown, index = "shannon",MARGIN=2))
Group <- rep("Radiolaria",7)
rad_biomarks_unknown <- cbind(rad_div_rosc_unknown,Group)
names(rad_biomarks_unknown)[1]<-paste("Shannon")
shannon_biomarks_unknown <- rbind(shannon_biomarks_unknown,rad_biomarks_unknown)

rad_div_rosc_known <- data.frame(diversity(Genus_rad_alpha_known, index = "shannon",MARGIN=2))
Group <- rep("Radiolaria",7)
rad_biomarks_known <- cbind(rad_div_rosc_known,Group)
names(rad_biomarks_known)[1]<-paste("Shannon")
shannon_biomarks_known <- rbind(shannon_biomarks_known,rad_biomarks_known)

rad_div_rosc_all <- data.frame(diversity(Genus_rad_alpha_all, index = "shannon",MARGIN=2))
Group <- rep("Radiolaria",7)
rad_biomarks_all <- cbind(rad_div_rosc_all,Group)
names(rad_biomarks_all)[1]<-paste("Shannon")
shannon_biomarks_all <- rbind(shannon_biomarks_all,rad_biomarks_all)
###
...
df_R <- data.frame(abund,division)
...
# Keep Dino Division
Genus_dino_unknown <- Genus[Genus$Division=="Dinoflagellata",]
Genus_dino_alpha_unknown <- data.frame(Genus_dino_unknown[,1:35])
rownames(Genus_dino_alpha_unknown)<-Genus_dino_alpha_unknown[,1]
Genus_dino_alpha_unknown[,1]<-NULL

Genus_known <- subset(ASV_tax_N, Genus != "Unknown")
Genus_dino_known <- Genus_known[Genus_known$Division=="Dinoflagellata",]
Genus_dino_alpha_known <- data.frame(Genus_dino_known[,1:35])
rownames(Genus_dino_alpha_known)<-Genus_dino_alpha_known[,1]
Genus_dino_alpha_known[,1]<-NULL

Genus_dino_all <- subset(ASV_tax_N, Division=="Dinoflagellata")
Genus_dino_alpha_all <- data.frame(Genus_dino_all[,1:35])
rownames(Genus_dino_alpha_all)<-Genus_dino_alpha_all[,1]
Genus_dino_alpha_all[,1]<-NULL
...
df_class_S_osl <- data.frame((colSums(S[,2:35])/colSums(Genus_dino[,2:35]))*100)
M_S_osl <- mean(df_class_S_osl[,1])
df_class_DD_osl <- data.frame((colSums(DD[,2:35])/colSums(Genus_dino[,2:35]))*100)
M_DD_osl <- mean(df_class_DD_osl[,1])

# Quantification of known and unknowns among Syndiniales and Dinophyceae
S <- ASV_tax_N[ASV_tax_N$Class=="Syndiniales",]
DD <- ASV_tax_N[ASV_tax_N$Class=="Dinophyceae",]

K_S_osl <- S[S$Genus!="Unknown",]
K_S_osl <-  mean(data.frame((colSums(K_S_osl[,2:35])/colSums(S[,2:35]))*100)[,1])
UK_S_osl <- S[S$Genus=="Unknown",]
UK_S_osl <- mean(data.frame((colSums(UK_S_osl[,2:35])/colSums(S[,2:35]))*100)[,1])

K_DD_osl <- DD[DD$Genus!="Unknown",]
K_DD_osl <- mean(data.frame(((colSums(K_DD_osl[,2:35])/colSums(DD[,2:35]))*100))[,1])
UK_DD_osl <- DD[DD$Genus=="Unknown",]
UK_DD_osl <- mean(data.frame(((colSums(UK_DD_osl[,2:35])/colSums(DD[,2:35]))*100))[,1])
#-#

# Shannon diversity index 
dino_div_osl_unknown <- data.frame(diversity(Genus_dino_alpha_unknown, index = "shannon",MARGIN=2))
Group <- rep("Dinoflagellata",34)
dino_biomarks_unknown <- cbind(dino_div_osl_unknown,Group)
names(dino_biomarks_unknown)[1]<-paste("Shannon")
shannon_biomarks_unknown <- rbind(shannon_biomarks_unknown,dino_biomarks_unknown)

dino_div_osl_known <- data.frame(diversity(Genus_dino_alpha_known, index = "shannon",MARGIN=2))
Group <- rep("Dinoflagellata",34)
dino_biomarks_known <- cbind(dino_div_osl_known,Group)
names(dino_biomarks_known)[1]<-paste("Shannon")
shannon_biomarks_known <- rbind(shannon_biomarks_known,dino_biomarks_known)

dino_div_osl_all <- data.frame(diversity(Genus_dino_alpha_all, index = "shannon",MARGIN=2))
Group <- rep("Dinoflagellata",34)
dino_biomarks_all <- cbind(dino_div_osl_all,Group)
names(dino_biomarks_all)[1]<-paste("Shannon")
shannon_biomarks_all <- rbind(shannon_biomarks_all,dino_biomarks_all)

# Keep Ochro Division
Genus_ochro_unknown <- Genus[Genus$Division=="Ochrophyta",]
Genus_ochro_alpha_unknown <- data.frame(Genus_ochro_unknown[,1:35])
rownames(Genus_ochro_alpha_unknown)<-Genus_ochro_alpha_unknown[,1]
Genus_ochro_alpha_unknown[,1]<-NULL

Genus_known <- subset(ASV_tax_N, Genus != "Unknown")
Genus_ochro_known <- Genus_known[Genus_known$Division=="Ochrophyta",]
Genus_ochro_alpha_known <- data.frame(Genus_ochro_known[,1:35])
rownames(Genus_ochro_alpha_known)<-Genus_ochro_alpha_known[,1]
Genus_ochro_alpha_known[,1]<-NULL

Genus_ochro_all <- subset(ASV_tax_N, Division=="Ochrophyta")
Genus_ochro_alpha_all <- data.frame(Genus_ochro_all[,1:35])
rownames(Genus_ochro_alpha_all)<-Genus_ochro_alpha_all[,1]
Genus_ochro_alpha_all[,1]<-NULL

# Shannon diversity index 
ochro_div_osl_unknown <- data.frame(diversity(Genus_ochro_alpha_unknown, index = "shannon",MARGIN=2))
Group <- rep("Ochrophyta",34)
ochro_biomarks_unknown <- cbind(ochro_div_osl_unknown,Group)
names(ochro_biomarks_unknown)[1]<-paste("Shannon")
shannon_biomarks_unknown <- rbind(shannon_biomarks_unknown,ochro_biomarks_unknown)

ochro_div_osl_known <- data.frame(diversity(Genus_ochro_alpha_known, index = "shannon",MARGIN=2))
Group <- rep("Ochrophyta",34)
ochro_biomarks_known <- cbind(ochro_div_osl_known,Group)
names(ochro_biomarks_known)[1]<-paste("Shannon")
shannon_biomarks_known <- rbind(shannon_biomarks_known,ochro_biomarks_known)

ochro_div_osl_all <- data.frame(diversity(Genus_ochro_alpha_all, index = "shannon",MARGIN=2))
Group <- rep("Ochrophyta",34)
ochro_biomarks_all <- cbind(ochro_div_osl_all,Group)
names(ochro_biomarks_all)[1]<-paste("Shannon")
shannon_biomarks_all <- rbind(shannon_biomarks_all,ochro_biomarks_all)

# Keep Cilio Division
Genus_cilio_unknown <- Genus[Genus$Division=="Ciliophora",]
Genus_cilio_alpha_unknown <- data.frame(Genus_cilio_unknown[,1:35])
rownames(Genus_cilio_alpha_unknown)<-Genus_cilio_alpha_unknown[,1]
Genus_cilio_alpha_unknown[,1]<-NULL

Genus_known <- subset(ASV_tax_N, Genus != "Unknown")
Genus_cilio_known <- Genus_known[Genus_known$Division=="Ciliophora",]
Genus_cilio_alpha_known <- data.frame(Genus_cilio_known[,1:35])
rownames(Genus_cilio_alpha_known)<-Genus_cilio_alpha_known[,1]
Genus_cilio_alpha_known[,1]<-NULL

Genus_cilio_all <- subset(ASV_tax_N, Division=="Ciliophora")
Genus_cilio_alpha_all <- data.frame(Genus_cilio_all[,1:35])
rownames(Genus_cilio_alpha_all)<-Genus_cilio_alpha_all[,1]
Genus_cilio_alpha_all[,1]<-NULL

# Shannon diversity index 
cilio_div_osl_unknown <- data.frame(diversity(Genus_cilio_alpha_unknown, index = "shannon",MARGIN=2))
Group <- rep("Ciliophora",34)
cilio_biomarks_unknown <- cbind(cilio_div_osl_unknown,Group)
names(cilio_biomarks_unknown)[1]<-paste("Shannon")
shannon_biomarks_unknown <- rbind(shannon_biomarks_unknown,cilio_biomarks_unknown)

cilio_div_osl_known <- data.frame(diversity(Genus_cilio_alpha_known, index = "shannon",MARGIN=2))
Group <- rep("Ciliophora",34)
cilio_biomarks_known <- cbind(cilio_div_osl_known,Group)
names(cilio_biomarks_known)[1]<-paste("Shannon")
shannon_biomarks_known <- rbind(shannon_biomarks_known,cilio_biomarks_known)

cilio_div_osl_all <- data.frame(diversity(Genus_cilio_alpha_all, index = "shannon",MARGIN=2))
Group <- rep("Ciliophora",34)
cilio_biomarks_all <- cbind(cilio_div_osl_all,Group)
names(cilio_biomarks_all)[1]<-paste("Shannon")
shannon_biomarks_all <- rbind(shannon_biomarks_all,cilio_biomarks_all)

# Keep Rad Division
Genus_rad_unknown <- Genus[Genus$Division=="Radiolaria",]
Genus_rad_alpha_unknown <- data.frame(Genus_rad_unknown[,1:35])
rownames(Genus_rad_alpha_unknown)<-Genus_rad_alpha_unknown[,1]
Genus_rad_alpha_unknown[,1]<-NULL

Genus_known <- subset(ASV_tax_N, Genus != "Unknown")
Genus_rad_known <- Genus_known[Genus_known$Division=="Radiolaria",]
Genus_rad_alpha_known <- data.frame(Genus_rad_known[,1:35])
rownames(Genus_rad_alpha_known)<-Genus_rad_alpha_known[,1]
Genus_rad_alpha_known[,1]<-NULL

Genus_rad_all <- subset(ASV_tax_N, Division=="Radiolaria")
Genus_rad_alpha_all <- data.frame(Genus_rad_all[,1:35])
rownames(Genus_rad_alpha_all)<-Genus_rad_alpha_all[,1]
Genus_rad_alpha_all[,1]<-NULL

# Shannon diversity index 
rad_div_osl_unknown <- data.frame(diversity(Genus_rad_alpha_unknown, index = "shannon",MARGIN=2))
Group <- rep("Radiolaria",34)
rad_biomarks_unknown <- cbind(rad_div_osl_unknown,Group)
names(rad_biomarks_unknown)[1]<-paste("Shannon")
shannon_biomarks_unknown <- rbind(shannon_biomarks_unknown,rad_biomarks_unknown)

rad_div_osl_known <- data.frame(diversity(Genus_rad_alpha_known, index = "shannon",MARGIN=2))
Group <- rep("Radiolaria",34)
rad_biomarks_known <- cbind(rad_div_osl_known,Group)
names(rad_biomarks_known)[1]<-paste("Shannon")
shannon_biomarks_known <- rbind(shannon_biomarks_known,rad_biomarks_known)

rad_div_osl_all <- data.frame(diversity(Genus_rad_alpha_all, index = "shannon",MARGIN=2))
Group <- rep("Radiolaria",34)
rad_biomarks_all <- cbind(rad_div_osl_all,Group)
names(rad_biomarks_all)[1]<-paste("Shannon")
shannon_biomarks_all <- rbind(shannon_biomarks_all,rad_biomarks_all)
###
...
df_O <- data.frame(abund,division)

# Biomarks sum of unknown metabarcode abundance 
df_V <- head(df_V[order(-df_V$abund),])
df_B <- head(df_B[order(-df_B$abund),])
df_G <- head(df_G[order(-df_G$abund),])
df_N <- head(df_N[order(-df_N$abund),])
df_R <- head(df_R[order(-df_R$abund),])
df_O <- head(df_O[order(-df_O$abund),])

Biomarks <- cbind(df_V, df_R, df_O, df_B, df_G, df_N)

# Biomarks Shannon div
Dataset <- rep("BioMarKs", 460)
...
#-#
# Quantification of Syndiniales and Dinophyceae among Dinoflagellata
# Syndiniales
mean(M_S_barc,M_S_gij,M_S_napl,M_S_osl,M_S_rosc,M_S_varna)

# Dinophyceae
mean(M_DD_barc,M_DD_gij,M_DD_napl,M_DD_oDDl,M_DD_roDDc,M_DD_varna)
#-#


##-- MALASPINA --##
# Read ASV table
abund2=read.csv("/shared/projects/formaldark/datasets/Malaspina/Mal_abund_N2_PR2_filt.csv",h=T, sep=",")
...
# Read abundance table
t=read.csv("/shared/projects/formaldark/datasets/Malaspina/ASV_Malaspina_filt_PR2_f200.csv",h=T, sep=";")
...
df <- data.frame(abund,division)

### Shannon α-div within Dinoflagellata, Ochrophyta, Ciliophora and Radiolaria
# Keep Dino Division
Genus_dino_unknown <- Genus[Genus$Division=="Dinoflagellata",]
Genus_dino_alpha_unknown <- data.frame(Genus_dino_unknown[,1:290])
rownames(Genus_dino_alpha_unknown)<-Genus_dino_alpha_unknown[,1]
Genus_dino_alpha_unknown[,1]<-NULL

Genus_known <- subset(ASV_tax_N, Genus != "Unknown")
Genus_dino_known <- Genus_known[Genus_known$Division=="Dinoflagellata",]
Genus_dino_alpha_known <- data.frame(Genus_dino_known[,1:290])
rownames(Genus_dino_alpha_known)<-Genus_dino_alpha_known[,1]
Genus_dino_alpha_known[,1]<-NULL

Genus_dino_all <- subset(ASV_tax_N, Division=="Dinoflagellata")
Genus_dino_alpha_all <- data.frame(Genus_dino_all[,1:290])
rownames(Genus_dino_alpha_all)<-Genus_dino_alpha_all[,1]
Genus_dino_alpha_all[,1]<-NULL
...
df_class_S <- data.frame((colSums(S[,2:290])/colSums(Genus_dino[,2:290]))*100)
df_class_S <- na.omit(df_class_S)
mean(df_class_S[,1])
df_class_DD <- data.frame((colSums(DD[,2:290])/colSums(Genus_dino[,2:290]))*100)
df_class_DD <- na.omit(df_class_DD)
mean(df_class_DD[,1])
...
K_S_mal <-  mean(na.omit(data.frame((colSums(K_S_mal[,2:290])/colSums(S[,2:290]))*100)[,1]))
UK_S_mal <- S[S$Genus=="Unknown",]
UK_S_mal <- mean(na.omit(data.frame((colSums(UK_S_mal[,2:290])/colSums(S[,2:290]))*100)[,1]))

K_DD_mal <- DD[DD$Genus!="Unknown",]
K_DD_mal <- mean(na.omit(data.frame(((colSums(K_DD_mal[,2:290])/colSums(DD[,2:290]))*100))[,1]))
UK_DD_mal <- DD[DD$Genus=="Unknown",]
UK_DD_mal <- mean(na.omit(data.frame(((colSums(UK_DD_mal[,2:290])/colSums(DD[,2:290]))*100))[,1]))
#-#
...
# Keep Ochro Division
Genus_ochro_unknown <- Genus[Genus$Division=="Ochrophyta",]
Genus_ochro_alpha_unknown <- data.frame(Genus_ochro_unknown[,1:290])
rownames(Genus_ochro_alpha_unknown)<-Genus_ochro_alpha_unknown[,1]
Genus_ochro_alpha_unknown[,1]<-NULL

Genus_known <- subset(ASV_tax_N, Genus != "Unknown")
Genus_ochro_known <- Genus_known[Genus_known$Division=="Ochrophyta",]
Genus_ochro_alpha_known <- data.frame(Genus_ochro_known[,1:290])
rownames(Genus_ochro_alpha_known)<-Genus_ochro_alpha_known[,1]
Genus_ochro_alpha_known[,1]<-NULL

Genus_ochro_all <- subset(ASV_tax_N, Division=="Ochrophyta")
Genus_ochro_alpha_all <- data.frame(Genus_ochro_all[,1:290])
rownames(Genus_ochro_alpha_all)<-Genus_ochro_alpha_all[,1]
Genus_ochro_alpha_all[,1]<-NULL
...
# Keep Cilio Division
Genus_cilio_unknown <- Genus[Genus$Division=="Ciliophora",]
Genus_cilio_alpha_unknown <- data.frame(Genus_cilio_unknown[,1:290])
rownames(Genus_cilio_alpha_unknown)<-Genus_cilio_alpha_unknown[,1]
Genus_cilio_alpha_unknown[,1]<-NULL

Genus_known <- subset(ASV_tax_N, Genus != "Unknown")
Genus_cilio_known <- Genus_known[Genus_known$Division=="Ciliophora",]
Genus_cilio_alpha_known <- data.frame(Genus_cilio_known[,1:290])
rownames(Genus_cilio_alpha_known)<-Genus_cilio_alpha_known[,1]
Genus_cilio_alpha_known[,1]<-NULL

Genus_cilio_all <- subset(ASV_tax_N, Division=="Ciliophora")
Genus_cilio_alpha_all <- data.frame(Genus_cilio_all[,1:290])
rownames(Genus_cilio_alpha_all)<-Genus_cilio_alpha_all[,1]
Genus_cilio_alpha_all[,1]<-NULL
...
# Keep Rad Division
Genus_rad_unknown <- Genus[Genus$Division=="Radiolaria",]
Genus_rad_alpha_unknown <- data.frame(Genus_rad_unknown[,1:290])
rownames(Genus_rad_alpha_unknown)<-Genus_rad_alpha_unknown[,1]
Genus_rad_alpha_unknown[,1]<-NULL

Genus_known <- subset(ASV_tax_N, Genus != "Unknown")
Genus_rad_known <- Genus_known[Genus_known$Division=="Radiolaria",]
Genus_rad_alpha_known <- data.frame(Genus_rad_known[,1:290])
rownames(Genus_rad_alpha_known)<-Genus_rad_alpha_known[,1]
Genus_rad_alpha_known[,1]<-NULL

Genus_rad_all <- subset(ASV_tax_N, Division=="Radiolaria")
Genus_rad_alpha_all <- data.frame(Genus_rad_all[,1:290])
rownames(Genus_rad_alpha_all)<-Genus_rad_alpha_all[,1]
Genus_rad_alpha_all[,1]<-NULL
...
Genus_sag_alpha_unknown <- data.frame(Genus_sag_unknown[,1:290])
rownames(Genus_sag_alpha_unknown)<-Genus_sag_alpha_unknown[,1]
Genus_sag_alpha_unknown[,1]<-NULL

Genus_known <- subset(ASV_tax_N, Genus != "Unknown")
Genus_sag_known <- Genus_known[Genus_known$Division=="Sagenista",]
Genus_sag_alpha_known <- data.frame(Genus_sag_known[,1:290])
rownames(Genus_sag_alpha_known)<-Genus_sag_alpha_known[,1]
Genus_sag_alpha_known[,1]<-NULL

Genus_sag_all <- subset(ASV_tax_N, Division=="Sagenista")
Genus_sag_alpha_all <- data.frame(Genus_sag_all[,1:290])
rownames(Genus_sag_alpha_all)<-Genus_sag_alpha_all[,1]
Genus_sag_alpha_all[,1]<-NULL
...
##-- MOOSE --##
# Read ASV table
abund2=read.csv("/shared/projects/formaldark/datasets/Moose/MOOSE_abund_N2_PR2_filt.csv",h=T, sep=",")
...
# Read abundance table
t=read.csv("/shared/projects/formaldark/datasets/Moose/ASV_MOOSE_filt_PR2_f200.csv",h=T, sep=";")
...
# Keep Dino Division
Genus_dino_unknown <- Genus[Genus$Division=="Dinoflagellata",]
Genus_dino_alpha_unknown <- data.frame(Genus_dino_unknown[,1:273])
rownames(Genus_dino_alpha_unknown)<-Genus_dino_alpha_unknown[,1]
Genus_dino_alpha_unknown[,1]<-NULL

Genus_known <- subset(ASV_tax_N, Genus != "Unknown")
Genus_dino_known <- Genus_known[Genus_known$Division=="Dinoflagellata",]
Genus_dino_alpha_known <- data.frame(Genus_dino_known[,1:273])
rownames(Genus_dino_alpha_known)<-Genus_dino_alpha_known[,1]
Genus_dino_alpha_known[,1]<-NULL

Genus_dino_all <- subset(ASV_tax_N, Division=="Dinoflagellata")
Genus_dino_alpha_all <- data.frame(Genus_dino_all[,1:273])
rownames(Genus_dino_alpha_all)<-Genus_dino_alpha_all[,1]
Genus_dino_alpha_all[,1]<-NULL
...
df_class_S <- data.frame((colSums(S[,2:273])/colSums(Genus_dino[,2:273]))*100)
df_class_S <- na.omit(df_class_S)
mean(df_class_S[,1])
df_class_DD <- data.frame((colSums(DD[,2:273])/colSums(Genus_dino[,2:273]))*100)
df_class_DD <- na.omit(df_class_DD)
mean(df_class_DD[,1])
...
K_S_moo <-  mean(na.omit(data.frame((colSums(K_S_moo[,2:273])/colSums(S[,2:273]))*100)[,1]))
UK_S_moo <- S[S$Genus=="Unknown",]
UK_S_moo <- mean(na.omit(data.frame((colSums(UK_S_moo[,2:273])/colSums(S[,2:273]))*100)[,1]))

K_DD_moo <- DD[DD$Genus!="Unknown",]
K_DD_moo <- mean(na.omit(data.frame(((colSums(K_DD_moo[,2:273])/colSums(DD[,2:273]))*100))[,1]))
UK_DD_moo <- DD[DD$Genus=="Unknown",]
UK_DD_moo <- mean(na.omit(data.frame(((colSums(UK_DD_moo[,2:273])/colSums(DD[,2:273]))*100))[,1]))
#-#

# Shannon diversity index 
dino_div_moo_unknown <- data.frame(diversity(Genus_dino_alpha_unknown, index = "shannon",MARGIN=2))
Group <- rep("Dinoflagellata",272)
...
# Keep Ochro Division
Genus_ochro_unknown <- Genus[Genus$Division=="Ochrophyta",]
Genus_ochro_alpha_unknown <- data.frame(Genus_ochro_unknown[,1:273])
rownames(Genus_ochro_alpha_unknown)<-Genus_ochro_alpha_unknown[,1]
Genus_ochro_alpha_unknown[,1]<-NULL

Genus_known <- subset(ASV_tax_N, Genus != "Unknown")
Genus_ochro_known <- Genus_known[Genus_known$Division=="Ochrophyta",]
Genus_ochro_alpha_known <- data.frame(Genus_ochro_known[,1:273])
rownames(Genus_ochro_alpha_known)<-Genus_ochro_alpha_known[,1]
Genus_ochro_alpha_known[,1]<-NULL

Genus_ochro_all <- subset(ASV_tax_N, Division=="Ochrophyta")
Genus_ochro_alpha_all <- data.frame(Genus_ochro_all[,1:273])
rownames(Genus_ochro_alpha_all)<-Genus_ochro_alpha_all[,1]
Genus_ochro_alpha_all[,1]<-NULL

# Shannon diversity index 
ochro_div_moo_unknown <- data.frame(diversity(Genus_ochro_alpha_unknown, index = "shannon",MARGIN=2))
Group <- rep("Ochrophyta",272)
...
# Keep Cilio Division
Genus_cilio_unknown <- Genus[Genus$Division=="Ciliophora",]
Genus_cilio_alpha_unknown <- data.frame(Genus_cilio_unknown[,1:273])
rownames(Genus_cilio_alpha_unknown)<-Genus_cilio_alpha_unknown[,1]
Genus_cilio_alpha_unknown[,1]<-NULL

Genus_cilio_known <- Genus_known[Genus_known$Division=="Ciliophora",]
Genus_cilio_alpha_known <- data.frame(Genus_cilio_known[,1:273])
rownames(Genus_cilio_alpha_known)<-Genus_cilio_alpha_known[,1]
Genus_cilio_alpha_known[,1]<-NULL

Genus_cilio_all <- subset(ASV_tax_N, Division=="Ciliophora")
Genus_cilio_alpha_all <- data.frame(Genus_cilio_all[,1:273])
rownames(Genus_cilio_alpha_all)<-Genus_cilio_alpha_all[,1]
Genus_cilio_alpha_all[,1]<-NULL

# Shannon diversity index 
cilio_div_moo_unknown <- data.frame(diversity(Genus_cilio_alpha_unknown, index = "shannon",MARGIN=2))
Group <- rep("Ciliophora",272)
...
# Keep Rad Division
Genus_rad_unknown <- Genus[Genus$Division=="Radiolaria",]
Genus_rad_alpha_unknown <- data.frame(Genus_rad_unknown[,1:273])
rownames(Genus_rad_alpha_unknown)<-Genus_rad_alpha_unknown[,1]
Genus_rad_alpha_unknown[,1]<-NULL

Genus_known <- subset(ASV_tax_N, Genus != "Unknown")
Genus_rad_known <- Genus_known[Genus_known$Division=="Radiolaria",]
Genus_rad_alpha_known <- data.frame(Genus_rad_known[,1:273])
rownames(Genus_rad_alpha_known)<-Genus_rad_alpha_known[,1]
Genus_rad_alpha_known[,1]<-NULL

Genus_rad_all <- subset(ASV_tax_N, Division=="Radiolaria")
Genus_rad_alpha_all <- data.frame(Genus_rad_all[,1:273])
rownames(Genus_rad_alpha_all)<-Genus_rad_alpha_all[,1]
Genus_rad_alpha_all[,1]<-NULL

# Shannon diversity index 
rad_div_moo_unknown <- data.frame(diversity(Genus_rad_alpha_unknown, index = "shannon",MARGIN=2))
Group <- rep("Radiolaria",272)
...
Genus_opa_alpha_unknown <- data.frame(Genus_opa_unknown[,1:273])
rownames(Genus_opa_alpha_unknown)<-Genus_opa_alpha_unknown[,1]
Genus_opa_alpha_unknown[,1]<-NULL

Genus_known <- subset(ASV_tax_N, Genus != "Unknown")
Genus_opa_known <- Genus_known[Genus_known$Division=="Opalozoa",]
Genus_opa_alpha_known <- data.frame(Genus_opa_known[,1:273])
rownames(Genus_opa_alpha_known)<-Genus_opa_alpha_known[,1]
Genus_opa_alpha_known[,1]<-NULL

Genus_opa_all <- subset(ASV_tax_N, Division=="Opalozoa")
Genus_opa_alpha_all <- data.frame(Genus_opa_all[,1:273])
rownames(Genus_opa_alpha_all)<-Genus_opa_alpha_all[,1]
Genus_opa_alpha_all[,1]<-NULL

# Shannon diversity index 
opa_div_moo_unknown <- data.frame(diversity(Genus_opa_alpha_unknown, index = "shannon",MARGIN=2))
Group <- rep("Opalozoa",272)
...
##-- ASTAN --##
# Read ASV table
abund2=read.csv("/shared/projects/formaldark/datasets/Astan/ASTAN_abund_N2_PR2_filt.csv",h=T, sep=",")
...
# Read abundance table
t=read.csv("/shared/projects/formaldark/datasets/Astan/ASV_ASTAN_filt_PR2_f200.csv",h=T, sep=";")
...
# Keep Dino Division
Genus_dino_unknown <- Genus[Genus$Division=="Dinoflagellata",]
Genus_dino_alpha_unknown <- data.frame(Genus_dino_unknown[,1:375])
rownames(Genus_dino_alpha_unknown)<-Genus_dino_alpha_unknown[,1]
Genus_dino_alpha_unknown[,1]<-NULL

Genus_known <- subset(ASV_tax_N, Genus != "Unknown")
Genus_dino_known <- Genus_known[Genus_known$Division=="Dinoflagellata",]
Genus_dino_alpha_known <- data.frame(Genus_dino_known[,1:375])
rownames(Genus_dino_alpha_known)<-Genus_dino_alpha_known[,1]
Genus_dino_alpha_known[,1]<-NULL

Genus_dino_all <- subset(ASV_tax_N, Division=="Dinoflagellata")
Genus_dino_alpha_all <- data.frame(Genus_dino_all[,1:375])
rownames(Genus_dino_alpha_all)<-Genus_dino_alpha_all[,1]
Genus_dino_alpha_all[,1]<-NULL
...
df_class_S <- data.frame((colSums(S[,2:375])/colSums(Genus_dino[,2:375]))*100)
df_class_S <- na.omit(df_class_S)
mean(df_class_S[,1])
df_class_DD <- data.frame((colSums(DD[,2:375])/colSums(Genus_dino[,2:375]))*100)
df_class_DD <- na.omit(df_class_DD)
mean(df_class_DD[,1])
...
K_S_ast <-  mean(data.frame((colSums(K_S_ast[,2:375])/colSums(S[,2:375]))*100)[,1])
UK_S_ast <- S[S$Genus=="Unknown",]
UK_S_ast <- mean(data.frame((colSums(UK_S_ast[,2:375])/colSums(S[,2:375]))*100)[,1])

K_DD_ast <- DD[DD$Genus!="Unknown",]
K_DD_ast <- mean(data.frame(((colSums(K_DD_ast[,2:375])/colSums(DD[,2:375]))*100))[,1])
UK_DD_ast <- DD[DD$Genus=="Unknown",]
UK_DD_ast <- mean(data.frame(((colSums(UK_DD_ast[,2:375])/colSums(DD[,2:375]))*100))[,1])
#-#
...
# Keep Ochro Division
Genus_ochro_unknown <- Genus[Genus$Division=="Ochrophyta",]
Genus_ochro_alpha_unknown <- data.frame(Genus_ochro_unknown[,1:375])
rownames(Genus_ochro_alpha_unknown)<-Genus_ochro_alpha_unknown[,1]
Genus_ochro_alpha_unknown[,1]<-NULL

Genus_known <- subset(ASV_tax_N, Genus != "Unknown")
Genus_ochro_known <- Genus_known[Genus_known$Division=="Ochrophyta",]
Genus_ochro_alpha_known <- data.frame(Genus_ochro_known[,1:375])
rownames(Genus_ochro_alpha_known)<-Genus_ochro_alpha_known[,1]
Genus_ochro_alpha_known[,1]<-NULL

Genus_ochro_all <- subset(ASV_tax_N, Division=="Ochrophyta")
Genus_ochro_alpha_all <- data.frame(Genus_ochro_all[,1:375])
rownames(Genus_ochro_alpha_all)<-Genus_ochro_alpha_all[,1]
Genus_ochro_alpha_all[,1]<-NULL
...
Genus_cerco_alpha_unknown <- data.frame(Genus_cerco_unknown[,1:375])
rownames(Genus_cerco_alpha_unknown)<-Genus_cerco_alpha_unknown[,1]
Genus_cerco_alpha_unknown[,1]<-NULL

Genus_known <- subset(ASV_tax_N, Genus != "Unknown")
Genus_cerco_known <- Genus_known[Genus_known$Division=="Cercozoa",]
Genus_cerco_alpha_known <- data.frame(Genus_cerco_known[,1:375])
rownames(Genus_cerco_alpha_known)<-Genus_cerco_alpha_known[,1]
Genus_cerco_alpha_known[,1]<-NULL

Genus_cerco_all <- subset(ASV_tax_N, Division=="Cercozoa")
Genus_cerco_alpha_all <- data.frame(Genus_cerco_all[,1:375])
rownames(Genus_cerco_alpha_all)<-Genus_cerco_alpha_all[,1]
Genus_cerco_alpha_all[,1]<-NULL
...
Genus_crypt_alpha_unknown <- data.frame(Genus_crypt_unknown[,1:375])
rownames(Genus_crypt_alpha_unknown)<-Genus_crypt_alpha_unknown[,1]
Genus_crypt_alpha_unknown[,1]<-NULL

Genus_known <- subset(ASV_tax_N, Genus != "Unknown")
Genus_crypt_known <- Genus_known[Genus_known$Division=="Cryptophyta",]
Genus_crypt_alpha_known <- data.frame(Genus_crypt_known[,1:375])
rownames(Genus_crypt_alpha_known)<-Genus_crypt_alpha_known[,1]
Genus_crypt_alpha_known[,1]<-NULL

Genus_crypt_all <- subset(ASV_tax_N, Division=="Cryptophyta")
Genus_crypt_alpha_all <- data.frame(Genus_crypt_all[,1:375])
rownames(Genus_crypt_alpha_all)<-Genus_crypt_alpha_all[,1]
Genus_crypt_alpha_all[,1]<-NULL
...
# Keep Opalozoa Division
Genus_opa_unknown <- Genus[Genus$Division=="Opalozoa",]
Genus_opa_alpha_unknown <- data.frame(Genus_opa_unknown[,1:375])
rownames(Genus_opa_alpha_unknown)<-Genus_opa_alpha_unknown[,1]
Genus_opa_alpha_unknown[,1]<-NULL

Genus_known <- subset(ASV_tax_N, Genus != "Unknown")
Genus_opa_known <- Genus_known[Genus_known$Division=="Opalozoa",]
Genus_opa_alpha_known <- data.frame(Genus_opa_known[,1:375])
rownames(Genus_opa_alpha_known)<-Genus_opa_alpha_known[,1]
Genus_opa_alpha_known[,1]<-NULL

Genus_opa_all <- subset(ASV_tax_N, Division=="Opalozoa")
Genus_opa_alpha_all <- data.frame(Genus_opa_all[,1:375])
rownames(Genus_opa_alpha_all)<-Genus_opa_alpha_all[,1]
Genus_opa_alpha_all[,1]<-NULL
...
##-- SOLA --##
# Read ASV table
abund2=read.csv("/shared/projects/formaldark/datasets/Sola/SOLA_abund_N2_PR2_filt.csv",h=T, sep=",")
...
# Read abundance table
t=read.csv("/shared/projects/formaldark/datasets/Sola/ASV_SOLA_filt_PR2_f200.csv",h=T, sep=";")
...
# Keep Dino Division
Genus_dino_unknown <- Genus[Genus$Division=="Dinoflagellata",]
Genus_dino_alpha_unknown <- data.frame(Genus_dino_unknown[,1:155])
rownames(Genus_dino_alpha_unknown)<-Genus_dino_alpha_unknown[,1]
Genus_dino_alpha_unknown[,1]<-NULL

Genus_known <- subset(ASV_tax_N, Genus != "Unknown")
Genus_dino_known <- Genus_known[Genus_known$Division=="Dinoflagellata",]
Genus_dino_alpha_known <- data.frame(Genus_dino_known[,1:155])
rownames(Genus_dino_alpha_known)<-Genus_dino_alpha_known[,1]
Genus_dino_alpha_known[,1]<-NULL

Genus_dino_all <- subset(ASV_tax_N, Division=="Dinoflagellata")
Genus_dino_alpha_all <- data.frame(Genus_dino_all[,1:155])
rownames(Genus_dino_alpha_all)<-Genus_dino_alpha_all[,1]
Genus_dino_alpha_all[,1]<-NULL
...
df_class_S <- data.frame((colSums(S[,2:155])/colSums(Genus_dino[,2:155]))*100)
df_class_S <- na.omit(df_class_S)
mean(df_class_S[,1])
df_class_DD <- data.frame((colSums(DD[,2:155])/colSums(Genus_dino[,2:155]))*100)
df_class_DD <- na.omit(df_class_DD)
mean(df_class_DD[,1])
...
K_S_sol <-  mean(na.omit(data.frame((colSums(K_S_sol[,2:155])/colSums(S[,2:155]))*100)[,1]))
UK_S_sol <- S[S$Genus=="Unknown",]
UK_S_sol <- mean(na.omit(data.frame((colSums(UK_S_sol[,2:155])/colSums(S[,2:155]))*100)[,1]))

K_DD_sol <- DD[DD$Genus!="Unknown",]
K_DD_sol <- mean(na.omit(data.frame(((colSums(K_DD_sol[,2:155])/colSums(DD[,2:155]))*100))[,1]))
UK_DD_sol <- DD[DD$Genus=="Unknown",]
UK_DD_sol <- mean(na.omit(data.frame(((colSums(UK_DD_sol[,2:155])/colSums(DD[,2:155]))*100))[,1]))
#-#

# Shannon diversity index 
dino_div_sol_unknown <- data.frame(diversity(Genus_dino_alpha_unknown, index = "shannon",MARGIN=2))
Group <- rep("Dinoflagellata",154)
...
# Keep Ochro Division
Genus_ochro_unknown <- Genus[Genus$Division=="Ochrophyta",]
Genus_ochro_alpha_unknown <- data.frame(Genus_ochro_unknown[,1:155])
rownames(Genus_ochro_alpha_unknown)<-Genus_ochro_alpha_unknown[,1]
Genus_ochro_alpha_unknown[,1]<-NULL

Genus_known <- subset(ASV_tax_N, Genus != "Unknown")
Genus_ochro_known <- Genus_known[Genus_known$Division=="Ochrophyta",]
Genus_ochro_alpha_known <- data.frame(Genus_ochro_known[,1:155])
rownames(Genus_ochro_alpha_known)<-Genus_ochro_alpha_known[,1]
Genus_ochro_alpha_known[,1]<-NULL

Genus_ochro_all <- subset(ASV_tax_N, Division=="Ochrophyta")
Genus_ochro_alpha_all <- data.frame(Genus_ochro_all[,1:155])
rownames(Genus_ochro_alpha_all)<-Genus_ochro_alpha_all[,1]
Genus_ochro_alpha_all[,1]<-NULL

# Shannon diversity index 
ochro_div_sol_unknown <- data.frame(diversity(Genus_ochro_alpha_unknown, index = "shannon",MARGIN=2))
Group <- rep("Ochrophyta",154)
...
# Keep Cercozoa Division
Genus_cerco_unknown <- Genus[Genus$Division=="Cercozoa",]
Genus_cerco_alpha_unknown <- data.frame(Genus_cerco_unknown[,1:155])
rownames(Genus_cerco_alpha_unknown)<-Genus_cerco_alpha_unknown[,1]
Genus_cerco_alpha_unknown[,1]<-NULL

Genus_known <- subset(ASV_tax_N, Genus != "Unknown")
Genus_cerco_known <- Genus_known[Genus_known$Division=="Cercozoa",]
Genus_cerco_alpha_known <- data.frame(Genus_cerco_known[,1:155])
rownames(Genus_cerco_alpha_known)<-Genus_cerco_alpha_known[,1]
Genus_cerco_alpha_known[,1]<-NULL

Genus_cerco_all <- subset(ASV_tax_N, Division=="Cercozoa")
Genus_cerco_alpha_all <- data.frame(Genus_cerco_all[,1:155])
rownames(Genus_cerco_alpha_all)<-Genus_cerco_alpha_all[,1]
Genus_cerco_alpha_all[,1]<-NULL

# Shannon diversity index 
cerco_div_sol_unknown <- data.frame(diversity(Genus_cerco_alpha_unknown, index = "shannon",MARGIN=2))
Group <- rep("Cercozoa",154)
...
Genus_cilio_unknown <- Genus[Genus$Division=="Ciliophora",]
Genus_cilio_alpha_unknown <- data.frame(Genus_cilio_unknown[,1:155])
rownames(Genus_cilio_alpha_unknown)<-Genus_cilio_alpha_unknown[,1]
Genus_cilio_alpha_unknown[,1]<-NULL

Genus_known <- subset(ASV_tax_N, Genus != "Unknown")
Genus_cilio_known <- Genus_known[Genus_known$Division=="Ciliophora",]
Genus_cilio_alpha_known <- data.frame(Genus_cilio_known[,1:155])
rownames(Genus_cilio_alpha_known)<-Genus_cilio_alpha_known[,1]
Genus_cilio_alpha_known[,1]<-NULL

Genus_cilio_all <- subset(ASV_tax_N, Division=="Ciliophora")
Genus_cilio_alpha_all <- data.frame(Genus_cilio_all[,1:155])
rownames(Genus_cilio_alpha_all)<-Genus_cilio_alpha_all[,1]
Genus_cilio_alpha_all[,1]<-NULL

# Shannon diversity index 
cilio_div_sol_unknown <- data.frame(diversity(Genus_cilio_alpha_unknown, index = "shannon",MARGIN=2))
Group <- rep("Ciliophora",154)
...
# Keep Opalozoa Division
Genus_opa_unknown <- Genus[Genus$Division=="Opalozoa",]
Genus_opa_alpha_unknown <- data.frame(Genus_opa_unknown[,1:155])
rownames(Genus_opa_alpha_unknown)<-Genus_opa_alpha_unknown[,1]
Genus_opa_alpha_unknown[,1]<-NULL

Genus_known <- subset(ASV_tax_N, Genus != "Unknown")
Genus_opa_known <- Genus_known[Genus_known$Division=="Opalozoa",]
Genus_opa_alpha_known <- data.frame(Genus_opa_known[,1:155])
rownames(Genus_opa_alpha_known)<-Genus_opa_alpha_known[,1]
Genus_opa_alpha_known[,1]<-NULL

Genus_opa_all <- subset(ASV_tax_N, Division=="Opalozoa")
Genus_opa_alpha_all <- data.frame(Genus_opa_all[,1:155])
rownames(Genus_opa_alpha_all)<-Genus_opa_alpha_all[,1]
Genus_opa_alpha_all[,1]<-NULL

# Shannon diversity index 
opa_div_sol_unknown <- data.frame(diversity(Genus_opa_alpha_unknown, index = "shannon",MARGIN=2))
Group <- rep("Opalozoa",154)
...
##-- BBMO --##
# Read ASV table
abund2=read.csv("/shared/projects/formaldark/datasets/BBMO/BBMO_abund_N2_PR2_filt.csv",h=T, sep=",")
...
# Read abundance table
t=read.csv("/shared/projects/formaldark/datasets/BBMO/ASV_BBMO_filt_PR2_f200.csv",h=T, sep=";")
...
# Keep Dino Division
Genus_dino_unknown <- Genus[Genus$Division=="Dinoflagellata",]
Genus_dino_alpha_unknown <- data.frame(Genus_dino_unknown[,1:328])
rownames(Genus_dino_alpha_unknown)<-Genus_dino_alpha_unknown[,1]
Genus_dino_alpha_unknown[,1]<-NULL

Genus_known <- subset(ASV_tax_N, Genus != "Unknown")
Genus_dino_known <- Genus_known[Genus_known$Division=="Dinoflagellata",]
Genus_dino_alpha_known <- data.frame(Genus_dino_known[,1:328])
rownames(Genus_dino_alpha_known)<-Genus_dino_alpha_known[,1]
Genus_dino_alpha_known[,1]<-NULL

Genus_dino_all <- subset(ASV_tax_N, Division=="Dinoflagellata")
Genus_dino_alpha_all <- data.frame(Genus_dino_all[,1:328])
rownames(Genus_dino_alpha_all)<-Genus_dino_alpha_all[,1]
Genus_dino_alpha_all[,1]<-NULL
...
df_class_S <- data.frame((colSums(S[,2:328])/colSums(Genus_dino[,2:328]))*100)
df_class_S <- na.omit(df_class_S)
mean(df_class_S[,1])
df_class_DD <- data.frame((colSums(DD[,2:328])/colSums(Genus_dino[,2:328]))*100)
df_class_DD <- na.omit(df_class_DD)
mean(df_class_DD[,1])
...
K_S_bbmo <-  mean(na.omit(data.frame((colSums(K_S_bbmo[,2:328])/colSums(S[,2:328]))*100)[,1]))
UK_S_bbmo <- S[S$Genus=="Unknown",]
UK_S_bbmo <- mean(na.omit(data.frame((colSums(UK_S_bbmo[,2:328])/colSums(S[,2:328]))*100)[,1]))

K_DD_bbmo <- DD[DD$Genus!="Unknown",]
K_DD_bbmo <- mean(na.omit(data.frame(((colSums(K_DD_bbmo[,2:328])/colSums(DD[,2:328]))*100))[,1]))
UK_DD_bbmo <- DD[DD$Genus=="Unknown",]
UK_DD_bbmo <- mean(na.omit(data.frame(((colSums(UK_DD_bbmo[,2:328])/colSums(DD[,2:328]))*100))[,1]))
#-#
...
# Keep Ochro Division
Genus_ochro_unknown <- Genus[Genus$Division=="Ochrophyta",]
Genus_ochro_alpha_unknown <- data.frame(Genus_ochro_unknown[,1:328])
rownames(Genus_ochro_alpha_unknown)<-Genus_ochro_alpha_unknown[,1]
Genus_ochro_alpha_unknown[,1]<-NULL

Genus_known <- subset(ASV_tax_N, Genus != "Unknown")
Genus_ochro_known <- Genus_known[Genus_known$Division=="Ochrophyta",]
Genus_ochro_alpha_known <- data.frame(Genus_ochro_known[,1:328])
rownames(Genus_ochro_alpha_known)<-Genus_ochro_alpha_known[,1]
Genus_ochro_alpha_known[,1]<-NULL

Genus_ochro_all <- subset(ASV_tax_N, Division=="Ochrophyta")
Genus_ochro_alpha_all <- data.frame(Genus_ochro_all[,1:328])
rownames(Genus_ochro_alpha_all)<-Genus_ochro_alpha_all[,1]
Genus_ochro_alpha_all[,1]<-NULL
...
# Keep Opalozoa Division
Genus_opa_unknown <- Genus[Genus$Division=="Opalozoa",]
Genus_opa_alpha_unknown <- data.frame(Genus_opa_unknown[,1:328])
rownames(Genus_opa_alpha_unknown)<-Genus_opa_alpha_unknown[,1]
Genus_opa_alpha_unknown[,1]<-NULL

Genus_known <- subset(ASV_tax_N, Genus != "Unknown")
Genus_opa_known <- Genus_known[Genus_known$Division=="Opalozoa",]
Genus_opa_alpha_known <- data.frame(Genus_opa_known[,1:328])
rownames(Genus_opa_alpha_known)<-Genus_opa_alpha_known[,1]
Genus_opa_alpha_known[,1]<-NULL

Genus_opa_all <- subset(ASV_tax_N, Division=="Opalozoa")
Genus_opa_alpha_all <- data.frame(Genus_opa_all[,1:328])
rownames(Genus_opa_alpha_all)<-Genus_opa_alpha_all[,1]
Genus_opa_alpha_all[,1]<-NULL
...
# Keep Sagenista Division
Genus_sag_unknown <- Genus[Genus$Division=="Sagenista",]
Genus_sag_alpha_unknown <- data.frame(Genus_sag_unknown[,1:328])
rownames(Genus_sag_alpha_unknown)<-Genus_sag_alpha_unknown[,1]
Genus_sag_alpha_unknown[,1]<-NULL

Genus_known <- subset(ASV_tax_N, Genus != "Unknown")
Genus_sag_known <- Genus_known[Genus_known$Division=="Sagenista",]
Genus_sag_alpha_known <- data.frame(Genus_sag_known[,1:328])
rownames(Genus_sag_alpha_known)<-Genus_sag_alpha_known[,1]
Genus_sag_alpha_known[,1]<-NULL

Genus_sag_all <- subset(ASV_tax_N, Division=="Sagenista")
Genus_sag_alpha_all <- data.frame(Genus_sag_all[,1:328])
rownames(Genus_sag_alpha_all)<-Genus_sag_alpha_all[,1]
Genus_sag_alpha_all[,1]<-NULL
...
# Keep Cryptophyta Division
Genus_crypt_unknown <- Genus[Genus$Division=="Cryptophyta",]
Genus_crypt_alpha_unknown <- data.frame(Genus_crypt_unknown[,1:328])
rownames(Genus_crypt_alpha_unknown)<-Genus_crypt_alpha_unknown[,1]
Genus_crypt_alpha_unknown[,1]<-NULL

Genus_crypt_known <- Genus_known[Genus_known$Division=="Cryptophyta",]
Genus_crypt_alpha_known <- data.frame(Genus_crypt_known[,1:328])
rownames(Genus_crypt_alpha_known)<-Genus_crypt_alpha_known[,1]
Genus_crypt_alpha_known[,1]<-NULL

Genus_crypt_all <- subset(ASV_tax_N, Division=="Cryptophyta")
Genus_crypt_alpha_all <- data.frame(Genus_crypt_all[,1:328])
rownames(Genus_crypt_alpha_all)<-Genus_crypt_alpha_all[,1]
Genus_crypt_alpha_all[,1]<-NULL
...
# Read data
don=read.csv("/shared/projects/formaldark/Data_stageM2/Dinoflag_Synd_Dinoph.csv",h=T, sep=";",stringsAsFactors = TRUE)
...
## Abundance
# Create data frame
K_S_biom <- mean(K_S_varna,K_S_rosc,K_S_osl,K_S_napl,K_S_gij,K_S_barc)
UK_S_biom <- mean(UK_S_varna,UK_S_rosc,UK_S_osl,UK_S_napl,UK_S_gij,UK_S_barc)

K_DD_biom <- mean(K_DD_varna,K_DD_rosc,K_DD_osl,K_DD_napl,K_DD_gij,K_DD_barc)
UK_DD_biom <- mean(UK_DD_varna,UK_DD_rosc,UK_DD_osl,UK_DD_napl,UK_DD_gij,UK_DD_barc)
