...
## Output
The homogenised global metabarcoding dataset resulting from the workflow (ASV_18SV4_6MetaB.csv) was explored in the script Normalisation_Alpha_div_Abund.Rmd which includes the normalisation of datasets and quantification of unassigned sequences across datasets and taxonomy.
